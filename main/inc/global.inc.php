...
if (isset($_user['language']) && api_get_self() != api_get_path(REL_PATH).'main/admin/configure_homepage.php') {
        if(in_array($_user['language'], $valid_languages['folder'])){
...
if (isset($_course['language'])) {
    if(in_array($_course['language'], $valid_languages['folder'])){
...
$language_files[] = 'admin';
$language_files[] = 'work';
$language_files[] = 'learnpath';
$language_files[] = 'exercice';
$language_files[] = 'document';
$language_files[] = 'scorm';
$language_files[] = 'install';
$language_files[] = 'agenda';
$language_files[] = 'reservation';
$language_files[] = 'course_home';
$language_files[] = 'create_course';
$language_files[] = 'group';
