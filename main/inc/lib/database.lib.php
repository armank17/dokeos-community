...
define('TABLE_MAIN_SESSION_REL_COURSE_REL_USER', 'session_rel_course_rel_user');
...
define('TABLE_MAIN_SESSION_CATEGORY_REL_TUTOR', 'session_category_rel_tutor');
define('TABLE_MAIN_PRODUCT', 'product');
define('TABLE_MAIN_PRODUCT_TOOL', 'product_tool');
define('TABLE_MAIN_PRODUCT_SETTINGS', 'product_settings');
define('TABLE_MAIN_TOOL', 'tool');
define('TABLE_MAIN_INVOICE', 'invoice');
define('TABLE_MAIN_NODE','node');
define('TABLE_MAIN_NODE_REL_COURSE','node_rel_course');
define('TABLE_MAIN_NODE_NEWS','node_news');
define('TABLE_MAIN_NODE_HOMEPAGE','node_homepage');
...
define('TABLE_MAIN_PAYMENT_COURSE_REL_USER', 'payment_course_rel_user');
define('TABLE_MAIN_PAYMENT_SESSION_REL_USER','payment_session_rel_user');
...
define('TABLE_MAIN_ECOMMERCE_CATEGORY', 'ecommerce_category');
...
define('TABLE_COURSE_NODE','course_node');
...
define('TABLE_EXAM', 'exam');
define('TABLE_EXAM_USER', 'exam_rel_user');
define('TABLE_CERTIFICATE', 'certificate');
define('TABLE_QUIZ_QUESTION_REL_USER','quiz_question_rel_user');
...
// WebTV
define('TABLE_WEBTV_CATALOGUE', 'webtv_catalogue');
define('TABLE_WEBTV_CHANNEL', 'webtv_channel');
define('TABLE_WEBTV_VIDEO', 'webtv_video');
define('TABLE_WEBTV_POSITION', 'webtv_position');

// Scenario Blender
define('TABLE_SCENARIO_STEPS', 'scenario_steps');
define('TABLE_SCENARIO_ACTIVITY', 'scenario_activity');
define('TABLE_SCENARIO_ACTIVITY_VIEW', 'scenario_activity_view');
define('TABLE_FACE_2_FACE', 'face_to_face');
...
class Database {
        ...
        //returns false when you can not connect
        public function openConnection()
        {
            include dirname(__FILE__).'/../conf/configuration.php';
            // Connect to the server database and select the main dokeos database.
            $connection = mysql_connect($_configuration['db_host'], $_configuration['db_user'], $_configuration['db_password']);
            return $connection;
	...
	*/
	...
	public static function get_course_info($course_code) {
		...
		$result = self::generate_abstract_course_field_names(
			self::fetch_array(self::query("SELECT * FROM $table WHERE `code` = '$course_code' OR `db_name` = '$course_code'", __FILE__, __LINE__)));
