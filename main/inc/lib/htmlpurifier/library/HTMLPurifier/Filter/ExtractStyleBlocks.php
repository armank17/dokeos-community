...
/**
 * This filter extracts <style type="text/css"> blocks from input HTML, cleans them up
...
class HTMLPurifier_Filter_ExtractStyleBlocks extends HTMLPurifier_Filter
{
    ...
    /**
     * Removes inline <style type="text/css"> tags from HTML, saves them for later use
    ...
    /**
     * Takes CSS (the stuff found in <style type="text/css">) and cleans it.
