...
';
    ...
    function toHtml()
    {
        ...
        if (strpos($this->_elementTemplate, '{unselected}') === false) {
            ...
            $this->_attributesUnselected = array('name' => '__'.$selectName, 'id'=>($selectId.'_active'), 'ondblclick' => "{$this->_jsPrefix}{$this->_jsPostfix}(this.form.elements['__" . $selectName . "'], this.form.elements['_" . $selectName . "'], this.form.elements['" . $selectName . "'], 'add')");
            ...
            $this->_attributesSelected = array('name' => '_'.$selectName, 'id'=>($selectId.'_active'), 'ondblclick' => "{$this->_jsPrefix}{$this->_jsPostfix}(this.form.elements['__" . $selectName . "'], this.form.elements['_" . $selectName . "'], this.form.elements['" . $selectName . "'], 'remove')");
            ...
            $this->_attributesHidden = array('name' => $selectName, 'id'=>($selectId.'_hidden'), 'style' => 'overflow: hidden; visibility: hidden; width: 1px; height: 0;');
