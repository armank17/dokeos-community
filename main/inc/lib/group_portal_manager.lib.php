		...
		if (count($members) > 0) {
			...
			echo '<div align="center">';
				...
				if (count($members) > $min_count_members) {
					//More link
					echo '<div class="group_member_more" style="margin-top:20px;"><a class="button_social" style="font-size: 12px;    height: 14px;     line-height: 15px;     padding: 5px !important;"href="group_members.php?id='.$group_id.'">'.get_lang('SeeMore').'</a></div>';
				}
			echo '</div>';
