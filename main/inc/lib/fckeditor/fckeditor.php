...
class FCKeditor
{
	 ...
	 * @return string
	 */
	public function CreateHtml($isFormValidator = false)
	{
		...
		else
		{
			...
			if ( strpos( $this->Height, '%' ) === false )
				...
				$HeightCSS = $this->Height ;
                        ...
                        if ($isFormValidator)  {
                            $Html .= "<textarea name=\"{$this->InstanceName}\" rows=\"4\" cols=\"40\" style=\"visibility:hidden;width: {$WidthCSS}; height: {$HeightCSS}\">{$HtmlValue}</textarea>" ;
                        }
                        else {
                ...
                if ($isFormValidator)  {
                    ...
                    return $open_wrap_txtarea.$Html.$loading_img.$close_wrap_txtarea;
                }
                else {
                    return $Html;
                }
