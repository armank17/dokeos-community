...
$Config['FileTypesPath']['Flash']				= $Config['UserFilesPath'] . 'animations/' ;
$Config['FileTypesAbsolutePath']['Flash']		= $Config['UserFilesAbsolutePath'] . 'animations/' ;
$Config['QuickUploadPath']['Flash']				= $Config['UserFilesPath'] . 'animations/' ;
$Config['QuickUploadAbsolutePath']['Flash']		= $Config['UserFilesAbsolutePath'] . 'animations/' ;
