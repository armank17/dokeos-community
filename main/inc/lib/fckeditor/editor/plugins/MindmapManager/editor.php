...
<? } ?>
	...
	<div id="tools_watermark" style="display:none;">
		...
		<div id="watermarkMessage" style="display: none;">
			<script type="text/javascript">document.write("<div id=\"tool_inputs\" style=\"text-align: center; width: 90%; color: #474767;\"><label style=\" font-weight: bold; letter-spacing: 3px;\">" + i18n("Watermarking is disabled.") + "</label><br /><label>" + i18n("No watermarks were found or all watermarks are to big for the target image.") + "</label></div>");</script>
		</div>
	</div>
