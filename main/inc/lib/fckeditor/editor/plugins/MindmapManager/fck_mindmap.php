...
<html>
	<head>
		...
		<script src="fck_mindmap.js" type="text/javascript"></script>
	...
	<body> <!--scroll="no" style="overflow: hidden"-->
					...
					<td>
						<table cellspacing="0" cellpadding="0" width="100%" border="0">
							...
							<td valign="top" width="100%">
								...
								<input id="mindmapUrl" onBlur="javascript:updatePreview();" style="width: 100%" type="text">
							</td>
		...
		<?php
			...
			$form = new FormValidator('frmUpload','POST','fck_mindmap_upload.php','','id="frmUpload" enctype="multipart/form-data"');
			...
			$form->add_real_progress_bar('fckMindmap','NewFile');
			$form->display();
		?>
		</div>
