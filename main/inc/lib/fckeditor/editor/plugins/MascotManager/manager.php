...
/*<![CDATA[*/
	...
	var base_url_alt= "<?php echo $base_url_alt.'mascot/'; ?>";
	...
	if ( window.opener )
	{
		...
		if ( window.opener.MascotManager && window.opener.MascotManager.I18N )
		{
			I18N = window.opener.MascotManager.I18N ;
		}
	...
	else if ( window.parent )
	{
		...
		if ( oEditor.MascotManager && oEditor.MascotManager.I18N )
		{
			I18N = oEditor.MascotManager.I18N ;
		}
	}
...
<fieldset style="margin-left: 15px; margin-right: 15px;"><legend>Mascot Manager</legend>
<div class="dirs">
...
<!-- image properties -->
	<table class="inputTable">
		<tr>
			...
			<td><input type="text" id="f_vert" class="smallWidth" value="0" disabled /></td>
		</tr>		
		<tr>
			...
			<td><input type="text" id="f_horiz" class="smallWidth" value="0" disabled /></td>
		</tr>
		<tr>
...
<?php } ?>
			...
			<td><input type="text" id="f_border" class="smallWidth" value="0" disabled /></td>
		</tr>
		<tr> 
...
<?php } ?>
				...
				<input type="checkbox" id="constrain_prop" checked="checked" onclick="javascript: toggleConstrains(this);" disabled />
			</td>
...
<!--	<div class="PopupButtons" style="width: 100%;">-->
	...
	<!--  <button type="button" class="refresh" onclick="javascript: return refresh();">Refresh</button>&nbsp;-->
          <button type="button" class="save" onclick="javascript: return onOK();">Validate</button>&nbsp;
