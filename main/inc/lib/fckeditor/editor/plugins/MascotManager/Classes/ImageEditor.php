	...
	function processAction($action, $relative, $fullpath)
	{
		...
		switch ($action)
		{
			...
			case 'watermark':
					...
					{
						echo "<script type='text/javascript'>alert(\"Error when loading '" . basename($fullpath) . "' - Loading '" . $img->type . "' files not supported\");</script>";
						return false;
					}
					...
					{
						echo "<script type='text/javascript'>alert(\"Error when loading '" . basename($watermarkFullPath) . "' - Loading '" . $img->type . "' files not supported\");</script>";
						return false;
					}
		...
		elseif ($action == "watermark")
		{
			...
			{
				echo "<script type='text/javascript'>alert(\"Error when saving '" . basename($newFullpath) . "' - Saving '" . $img->type . "' files not supported\");</script>";
				return false;
			}
		}
		else
