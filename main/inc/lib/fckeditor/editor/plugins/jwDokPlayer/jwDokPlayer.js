...
Media.prototype.getInnerHTML = function ( objectId )
{
    ...
    var mysplit = this.url.split('/');
    var myFileName = mysplit[mysplit.length - 1];
    ...
    p += '<param name="movie" value="' + FCKConfig.SWFJwPlayer + '" />' ;
    ...
    v += 'file=' + FCKConfig.VideosFilesPathJwPlayer+myFileName + '&amp;' ;
    v += 'repeat=' + this.loop + '&amp;' ;
    v += 'image=' + this.iurl + '&amp;' ;        
