...
<table style="width: 100%; border: none;">
  <tr>
    ...
    <td style="width:50%;"><input id="show_mathml" type="button" ckLang="DlgAsciiMathShowMathML" onclick="javascript: ShowMathML();" style="float: right; font-size: 10px;" value="<?php echo get_lang('ShowMathML'); ?>" /><span ckLang="DlgAsciiMathPreview"><?php echo get_lang('Preview'); ?></span></td>
  </tr>
  <tr>
    <td>
