...
CKEDITOR.lang['fr'] = {
    ...
    "slideshow": {
        "toolbar": "Caroussel",
        "dialogTitle": "Propriétés du Caroussel",
        ...
        "insertSlideShow": "Insérer un Caroussel"
    },
    "placeholder": {
    ...
    "xmas": {
        ...
        "wishes": "<p>L'équipe $1vous souhaite?</p><p class=\"big\">Des joyeuses fêtes!</p>"
    },
    "eqneditor": {
    ...
    "imgmap": {
        ...
        "button_title": "Insérez l'image carte",
    ...
    "video" : {
        ...
        "videoFileFormatsAccepted": "Les formats de fichiers vidéo acceptable",
        "youtubeVimeo" : "Youtube & Vimeo",
        "goTo": "Allez à",
        "or": " ou",
        "navigateWithinTheSiteToFindYourVideo": "Browse the site to find your video.",
        "copyUrlvideoFromBrowser": "Copiez l'adresse URL de la vidéo à partir de la barre d'adresse de votre navigateur et collez-le dans cette boîte de dialogue, la case URL.",
        "theCopiedUrlShouldLookLike": "L'URL copié devrait ressembler http://www.youtube.com/watch?v=XXXX (XXXX = youtube id)",
        "invalidFileType" : "Type de fichier non valide",
        "sourceVideoHtml" : "Source vidéo HTML",
        "dialogTitle" : "Titre dialogue",
        "videoStreaming": "Le streaming vidéo"
