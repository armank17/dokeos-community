			...
			for ($k=0;$k<$loop_friends;$k++) {
				...
				while ($j<$number_of_images) {
					if (isset($friends[$j])) {
						...
						$friend_html.='<img onclick="delete_friend (this)" id="img_'.$friend['friend_user_id'].'" src="../img/blank.gif" alt="" title=""  class="image-delete" /> <center class="friend"><a href="profile.php?u='.$friend['friend_user_id'].'" style="display: block; text-align: center;">'.$user_name.'</a></center></div>';
					}
					$j++;
				}
				$friend_html.='</td></tr>';
