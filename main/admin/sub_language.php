...
$html.='<form id="Searchlanguage" name="Searchlanguage" method="GET" action="sub_language.php">';
$html.='<div style="float:left; padding-top:12px;">'.get_lang('OriginalName').'&nbsp;:&nbsp;</div>';
...
$html.='<div class="float:left"><input style="float:left" name="txt_search_word" type="text" size="50"  id="txt_search_word" value="'.Security::remove_XSS($_REQUEST['txt_search_word']).'" /><button style="height:30px; margin-top:3px; float:left" name="SubmitSearchLanguage" class="search" type="submit">'.get_lang('Search').' </button></div>';
$html.='</form>';
