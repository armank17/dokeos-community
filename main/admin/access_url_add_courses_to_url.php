...
echo '<a href="'.api_get_path(WEB_CODE_PATH).'admin/access_url_edit_courses_to_url.php">'.Display::return_icon('pixel.gif',get_lang('EditCoursesToURL'), array('class' => 'toolactionplaceholdericon toolactionedit_32')).get_lang('EditCoursesToURL').'</a>';
echo '</div>';
	...
	if ($form_sent == 1) {
		if ( count($courses) == 0 || count($url_list) == 0) {
			//Display :: display_error_message(get_lang('AtLeastOneCourseAndOneURL'));
                        $_SESSION['display_error_message']=get_lang('AtLeastOneCourseAndOneURL');
			...
			//Display :: display_confirmation_message(get_lang('CourseBelongURL'));
                        $_SESSION['display_confirmation_message']=get_lang('CourseBelongURL');
 ...
 <input type="hidden" name="form_sent" value="1"/>
  <table border="0" cellpadding="5" cellspacing="0" width="100%">
   ...
   <td width="20%" valign="middle" align="center">
    ...
    <button class="save" type="submit" value="<?php echo get_lang('AddCoursesToThatURL'); ?> &gt;&gt;"/><?php echo get_lang('AddCoursesToThatURL'); ?></button>
   </td>
   <td width="40%" align="center">
