...
echo '<a href="'.api_get_path(WEB_CODE_PATH).'admin/access_url_add_courses_to_url.php">'.Display::return_icon('pixel.gif',get_lang('AddCoursesToURL'), array('class' => 'toolactionplaceholdericon toolactionautomaticenrollment')).get_lang('AddCoursesToURL').'</a>';
echo '</div>';
echo '<div id="content">';
...
//			echo '<input type="button" value="'.get_lang('EditCourses').'" onclick="valide()" />';
			echo '<div class="pull-bottom"><button onclick="valide()" value="'.get_lang('EditCourses').'" type="button" class="save" ">'.get_lang('EditCourses').'</button></div>';
		else
//			echo '<input type="button" value="'.get_lang('EditCourses').'" onclick="valide()" />';
			echo '<div class="pull-bottom"><button onclick="valide()" value="'.get_lang('EditCourses').'" type="button" class="save" ">'.get_lang('EditCourses').'</button></div>';
		?>
