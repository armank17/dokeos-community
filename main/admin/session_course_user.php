...
<tr>
    <td align="center" colspan="3">
        ...
        <?php
//	echo '<button class="save" type="button" value="" onclick="validexxx()" style="float:none;">'.get_lang('EditSessionCourses').'</button>';
        echo '<button class="save" type="button" value="" onclick="valide()" style="float:none;">'.get_lang('EditSessionCourses').'</button>';
	?>
