...
echo '<a href="'.api_get_path(WEB_CODE_PATH).'admin/access_url_add_users_to_url.php">'.Display::return_icon('pixel.gif',  get_lang('AddUrl'), array('class'=>'toolactionplaceholdericon toolactionadd')).get_lang('AddUrl').'</a>';
echo '<a href="'.api_get_path(WEB_CODE_PATH).'admin/access_url_add_users_in_batch_to_sites.php">'.Display::return_icon('pixel.gif',  get_lang('ImportUsersToURL'), array('class'=>'toolactionplaceholdericon toolactionexportcourse')).get_lang('ImportUsersToURL').'</a>';
echo '</div>';
...
if($ajax_search) {
	...
	$sql="SELECT u.user_id, lastname, firstname, username
	  	  	FROM $tbl_user u WHERE lastname<>'Anonymous'".
			$order_clause;
