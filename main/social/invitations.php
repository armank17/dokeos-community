                ...
                <tbody>
                    <tr class="row_odd">
                        ...
                        <td class="info">
                            ...
                            <div class="buttons">
                                <button class="save_link" name="btn_accepted" type="submit" id="<?php echo "btn_accepted_" . $sender_user_id ?>" value="<?php echo get_lang('Accept'); ?>"onclick="javascript:register_friend(this)">
...
if (count($pending_invitations) > 0) {
    ...
    foreach ($pending_invitations as $invitation) {
        ...
        $invitation['join'] = '<div id="inv_join"><a href="invitations.php?accept=' . $invitation['id'] . '">' . Display::return_icon('accept_invitation.png', get_lang('AcceptInvitation')) . '&nbsp;&nbsp;' . get_lang('AcceptInvitation') . '</div></a>';
        $invitation['deny'] = '<div id="inv_deny"><a href="invitations.php?deny=' . $invitation['id'] . '">' . Display::return_icon('denied_invitation.png', get_lang('DenyInvitation')) . '&nbsp;&nbsp;' . get_lang('DenyInvitation') . '</div></a>';
...
if(api_get_setting('display_feedback_messages')== 'false'){
    if(isset($_GET['accept'])){
        //echo 'dsfsdfsd';
        header('Location: '.  api_get_path(WEB_PATH).'main/social/groups.php');
        ob_end_flush();
    }
}
// Actions
