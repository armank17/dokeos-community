...
include_once (api_get_path(LIBRARY_PATH) . 'timezone.lib.php');

header('Content-type: text/html; charset=' . api_get_setting('platform_charset'));
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        <title></title>
        <meta http-equiv="Content-Type" content="text/html; charset=<?php echo api_get_setting('platform_charset'); ?>" />
...
// but the problem is that the visibility of the forum AND forum cateogory are stored in the item_property table
        ...
        $session_id_course = $_REQUEST['id_session'];
        if ($session_id_course == '')
            $session_id_course = 0;
        ...
        while ($row = Database::fetch_array($result)) {
            ...
            if ($row['session_id'] == $session_id_course) {
                //abre
                echo "\t<tr>\n";
                ...
                echo $name .'<br/>';
                echo TimeZone::ConvertTimeFromServerToUser(api_get_user_id(), $row['post_date']) .'<br/><br/>';
                echo "</td>\n";
