...
<?php } ?>    
	<div class="section main_activity">
            <span class="sectiontitle"><?php echo get_lang("Basic") ?></span>
            <table>
                <?php $my_list = get_tools_category(TOOL_BASIC); show_tools_category($my_list); ?>
            </table>
	</div>        
<?php if (api_get_setting('enable_pro_settings') !== "true") { ?>
	<div id="pro_tools" class="section main_activity">
            <span class="sectiontitle"><?php echo get_lang("Advanced") ?></span>
<?php   show_pro_tools();
    } else { ?>
	<div class="section main_activity">
            <span class="sectiontitle"><?php echo get_lang("Advanced") ?></span>
            <table>
                <?php $my_list = get_tools_category(TOOL_ADVANCED); show_tools_category($my_list); ?>
            </table>
<?php } ?>
        </div>
	<?php
