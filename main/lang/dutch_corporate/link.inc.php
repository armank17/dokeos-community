...
$langCsvImport = "CSV-bestand importeren";
$General = "Algemeen";
$SearchFeatureDoIndexLink = "Indexeer linktitel en omschrijving?";
$langSaveLink = "Link opslaan";
$langSaveCategory = "Map opslaan";
$BackToLinksOverview = "Terug naar het links-overzicht";
$AddTargetOfLinkOnHomepage = "Selecteer de bestemming van de link voor de cursus-startpagina";
$Url = "URL";
$Objective = "Doel";
$FolderName = "Mapnaam";
$Fold = "Compact overzicht";
$Unfold = "Uitgebreid overzicht";
$ThereAreNoLinksInThisFolder = "Geen links in deze map";
$IntegrateLinkInCourse = "Link in cursus integreren";
?>