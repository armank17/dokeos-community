...
$UploadExtensionsListTypeComment = "Utilizar un filtrado para lista negra o lista blanca. Para más detalles, vea más abajo la descripción ambos filtros.";
...
$NoReplyEmailAddress = "No responder a este correo";
...
$NoReplyEmailSender = "No responder a este correo";
$Flat = "Plana";
...
$ShowForcePasswordChangeTitle = "Mostrar la opcion de forzar password";
...
$Paypal = "Paypal";
$Weeks = "Semanas";
$OptionSelectionText = "Opciones selección de texto";
$PaymentMessage = "Métodos de Mensaje de pago";
$CompanyLogo = "Logotipo de la compañía";
$Programme = "Programa";
$TopicLanguage = "Idioma";
$Keywords = "Palabras clave";
$Tax = "Impuesto (IVA)";
$AddToCart = "Agregar a carrito de compras";
$ShowCatalogueTitle = "Mostrar Catálogo";
$ShowCatalogueComment = "Visualizar el catálogo de productos para comprar";
$Street = "Calle";
$Individual = "Individual";
$Collectivity = "Colectiva";
$ShowAutomaticGroupTitle = "Grupos de llenado automático";
$ShowAutomaticGroupComment = "Cuando un usuario se registra para un curso o sesión, agregue el / ella a un grupo en curso";
$ShowNewGroupTitle = "Crear grupos si no hay asientos disponibles";
$ShowNewGroupComment = "When there are no seats available in Groups for automatic registration, add a group";
$ShowNewGroupSeatTitle = "No hay asientos en el grupo";
$ShowNewGroupSeatComment = "No hay asientos para asignar un nuevo grupo creado";
$AddSlides = "Agregar diapositivas";
$AltText = "Texto alternativo";
$Caption = "Título";
$DefaultImagesize = "Imágenes PNG o JPG, 240x720 píxeles";
$SlidesManagement = "Deslizador";
$SlidesList = "Lista de Diapositivas";
$Picture = "Imagen";
$YourTitle1 = "Tu título 1";
$YourTitle2 = "Tu título 2";
$YourTitle3 = "Tu título 3";
$YourCaption1 = "Tu título 1";
$YourCaption2 = "Tu título 2";
$YourCaption3 = "Tu título 3";
$AltText1 = "Texto alternativo 1";
$AltText2 = "Texto alternativo 2";
$AltText3 = "Texto alternativo 3";
$SlideScenario = "Escenario";
$ShowSlide = "Mostrar";
$SlideSpeed = "Velocidad de presentación";
...
$UseDefaultEditorComment = "Actualmente recomendamos usar Ckeditor";
...
$SearchEnabledTitle = "Buscador";
$SearchEnabledComment = "Activar la herramienta de busquedas";
...
$ShowForcePasswordChangeTitleComment = "Permite limitar el maximo de intentos en el proceso de logueo";
$LogoUrlTitle = "URL del logo ";
$LogoUrlComment = "El Logo de la Institución (enlace que aparece en el lado derecho de la cabecera)";
...
$Signature = "Firma";
$Token = "Token";
$CertificateTool = "Herramienta Certificado";
$Score = "Puntaje";
$AdminManual = "Manual del administrador";
$DokeosProfessional = "Dokeos PRO";
$Settings = "Configuración";
$Products = "Productos";
$Invoices = "Recibos";
$SelectTrainer = "Seleccione Instructor";
$CourseAverageValues = "Valores promedio de curso";
$Learners = "Estudiantes";
$ModulesTime = "Tiempo de módulos";
$ModulesProgress = "Progreso de módulos";
$ModulesScore = "Puntuación de módulos";
$QuizzesScore = "Puntuación de ejercicios";
$SelectCourses = "Seleccione curso";
$ModulesAverageValues = "Valores medios del módulo";
$InCourse = "en curso";
$Time = "Tiempo";
$Progress = "Progreso";
$Quizzes = "Ejercicios";
$QuizzesAverageValues = "Valores medio de Ejercicios";
...
$InActiveLearners = "Estudiantes inactivos";
$QuizzesRanking = "Ranking de ejercicios";
$LastName = "Apellidos";
$FirstName = "Nombre";
$LatestConnection = "Última conexión";
$OverallInformation = "Información general";
$AccessDetails = "Detalles de acceso";
$SendMail = "Enviar email";
$Status = "Estado";
$Email = "correo electronico";
$FirstConnection = "Primera conexión";
$TimeSpentInModules = "Tiempo usado en los módulos";
$ScoreInModules = "Puntuacion en módulos";
$ProgressInModules = "El progreso en los módulos";
$QuizzesScore = "Puntuación de ejercicios";
$LoginToTheCourse = "Entrar al Curso";
$Attempts = "Intentos";
$Search = "Buscar";
$BankInformation = "Información Bancaria";
$SelectInvoiceLogo = "Seleccionar logo de factura";
...
$DisplayImages = "Mostrar imágenes";
$PaymentAccepted = "Pago Aceptado";
$CreditCardMessage = "Mensaje de tarjeta de crédito";
$MessageWhenEndPayment = "Mensaje cuando se ha pagado";
$PaymentSection = "Sección de pago";
$TermsAndConditionsComment = "Términos y condiciones";
$EcommerceVisibleCatalog = "Catálogo visible de e-Commerce";
$EcommerceNameOfCategory = "Nombre de la categoría";
$EcommerceAddCategoryProducts = "Agregar nueva categoría";
$EcommerceCost = "Costo";
$EcommerceDuration = "Duración";
$EcommerceProfile = "Perfil";
$EcommercePreview = "Vista previa";
$EcommercePNGorJPGimages = "PNG o JPG";
$EcommerceRomeveImageAndWithoutImage = "Remover imagen";
$EcommerceDescription = "Descripción";
$Action = "Acción";
$ScenarioOverview = "Visión general del escenario";
$Import = "Importar";
$Import = "Importar";
$Unsubscribe = "Desinscribir";
$UseFiltersToSelectReporting = "Utilizar filtros en la parte superior para seleccionar datos";
?>