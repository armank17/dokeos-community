...
$ScenarioText1 = "Los alumnos interactúan sólo con el tutor. No hay interacción entre los estudiantes.";
$ScenarioText2 = "Los alumnos interactúan con el tutor y con los demás. Y pueden ver (pero no editar) los demás documentos de los grupos.";
$ScenarioText3 = "Los alumnos interactúan con el tutor y con los demás. Y ellos no pueden ver a otros grupos de trabajos.";
$ScenarioTools1 = "Herramientas: Tareas + correo electrónico privado.";
$ScenarioTools2 = "Herramientas: Tareas + correo electrónico privado + Chat + Foro + Documentos + Wiki";
$ScenarioTools3 = "Herramientas: Tareas + correo electrónico privado + Chat + Foro + Documentos + Wiki";
$GroupChat = "Chat";
?>