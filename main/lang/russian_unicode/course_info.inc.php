...
$ConfigChat = "Параметры настройки чата ";
$AllowOpenchatWindow = "Открыть чат в новом Окне";
$AllowOpenChatWindowActivate = "Активизировать открытие чата в новом окне";
$AllowOpenChatWindowDeactivate = "Дезактивировать открытие чата в новом окне";
$NewUserEmailAlert = "Уведомить по электронной почте тренера об автоматической подписке нового пользователя ";
$NewUserEmailAlertEnable = "Позволить уведомить по электронной почте тренера об автоматической подписке нового пользователя";
$NewUserEmailAlertToTeacharAndTutor = "Позволить уведомить по электронной почте тренера и наставников об автоматической подписке нового пользователя";
$NewUserEmailAlertDisable = "Отменить предупреждение электронной почты  о подписки нового пользователя в обучении";
?>