...
$IntroductionWiki = "Слово Wiki коротко для WikiWikiWeb. Wikiwiki - Гавайское слово, означает \"быстро\" или \"скорость\". В wiki люди пишут страницы вместе. Если один человек пишет что - то не так, следующий человек может исправить это. Следующий человек может также добавить что-то новое на страницу. Из-за этого страницы улучшаются непрерывно. ";
$CreateCourseArea = "Создать это обучение ";
$CreateCourse = "Создать обучение ";
$Create = "Создать ";
$MessageOfNewCourseToAdmin = "Это сообщение должно сообщить Вам о создании нового курса на платформе ";
$NewCourseCreatedIn = "Новый курс, созданный в ";
$ExplicationTrainers = "Вы установлены в статусе тренера. Вы можете изменить эти настройки позже в  настройках конфигурации";
?>