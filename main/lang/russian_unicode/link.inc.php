...
$General = "Общий";
$SearchFeatureDoIndexLink = "Индекс названия ссылки и описания? ";
$langSaveLink = "Сохранить связь ";
$langSaveCategory = "Сохранить папку ";
$BackToLinksOverview = "Назад к краткому обзору связей ";
$AddTargetOfLinkOnHomepage = "Выберите \"цель\", которая показывает связь на начальной странице курса";
?>