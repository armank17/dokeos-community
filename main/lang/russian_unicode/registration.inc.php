...
$CurrentPasswordEmptyOrIncorrect = "Текущий пароль  неправильный";
...
$PictureUploaded = "Ваша картинка была загружена ";
$ProductionUploaded = "Ваш файл производства был загружен ";
$FolderUpdated = "Папка обновлена ";
$UsersRegistered = "Эти пользователи были зарегистрированы на обучение ";
$UserAlreadyRegisterByOtherCreator = "Пользователь уже зарегистрирован другим тренером";
$UserCreatedPlatform = "Пользователь создан в портале ";
$UserInSession = "Пользователь добавлен в сессию ";
$UserNotAdded = "Пользователь не добавлен. ";
$NoSessionId = "Сессия не была идентифицирована ";
$NoUsersRead = "Пожалуйста проверьте свой файл XML/CVS ";
$UserImportFileMessage = "Если в файле XML/CVS логины будут отсутствовать, то имя и фамилия соединятся  для логина, то есть Хулио Монтоя будет jmontoya ";
$UserAlreadyRegisteredByOtherCreator = "Пользователь уже зарегистрирован другим тренером.";
$NewUserInTheCourse = "Новый пользователь в обучении ";
$MessageNewUserInTheCourse = "В обучении есть новый пользователь ";
$EditNormalProfile = "Отредактировать нормальный профиль ";
$EditExtendProfile = "Отредактировать расширенный профиль ";
$EditInformation = "Отредактировать профиль ";
$RegisterUser = "Зарегистрироваться ";
$IHaveReadAndAgree = "Я читал и соглашаюсь на ";
$ByClickingRegisterYouAgreeTermsAndConditions = "Нажимая \'зарегестрироваться\' ниже Вы соглашаетесь на Сроки и Условия ";
$User = "Пользователь ";
$LostPass = "Забыли свой пароль? ";
$EnterEmailUserAndWellSendYouPassword = "Введите имя пользователя или адрес электронной почты,на который Вы зарегистрировались, и мы пошлем Ваш пароль. ";
$NoUserAccountWithThisEmailAddress = "Не существует аккаунта с таким пользователем и/или адресом электронной почты ";
$WithTheFollowingSettings = "со следующими параметрами настройки:";
?>