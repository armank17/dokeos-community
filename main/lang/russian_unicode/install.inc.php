...
$FailedConectionDatabase = "Соединение с базой данных потерпело неудачу. Это происходит  из-за ошибки пользователя, введения неправильного пароля или неправильной приставки базы данных, устанавливаемой выше. Пожалуйста рассмотрите эти параметры настройки и попробуйте еще раз. ";
$EncryptMethodUserPass = "Метод шифрования";
$UpgradeFromDokeos16x = "Модернизация от Dokeos 1.6.x ";
$UpgradeFromDokeos18x = "Модернизация от Dokeos 1.";
?>