...
$TabsMyCourses = "I miei corsi";
$TabsCampusHomepage = "Home";
$TabsReporting = "Statistiche";
$TabsPlatformAdministration = "Amministrazione";
...
$AllowSocialToolTitle = "Abilita Social Network";
$AllowSocialToolComment = "La Social network consente agli utenti di definire le relazioni con gli altri utenti, formando gruppi di amici. La Comunità si combina con il sistema di messaggistica, creando uno strumento di socializzazione tra amici all\'interno del portale.";
...
$AllowStudentsToCreateGroupsInSocialTitle = "Consenti ai corsisti di creare gruppi nella Social network";
$AllowStudentsToCreateGroupsInSocialComment = "Consenti ai corsisti di creare gruppi nella Social network";
...
$ShowForcePasswordChangeTitle = "Opzione \"Forza il cambio della password\"";
...
$TabsSearch = "Cerca";
$DokeosProFeaturesAuthor = "Autore";
...
$ServicePpt2lpComment = "Attiva la conversione Presentazione - Modulo didattico";
$SearchEnabledTitle = "Motore di ricerca";
$SearchEnabledComment = "Attiva la funzione Motore di ricerca";
$DokeosProFeaturesLms = "LMS";
$DokeosProFeaturesEvaluate = "Valuta";
$DokeosProFeaturesShop = "Negozio";
$DokeosProFeaturesLive = "Dal vivo";
$DokeosProFeaturesWebTv = "Web TV";
$ShowForcePasswordChangeTitleComment = "Permetti un numero limitato di tentativi di accesso";
$LogoUrlTitle = "URL del Logo";
$LogoUrlComment = "Logo dell\'Istituzione (appare in altro a destra come collegamento al sito dell\'istituzione)";
...
$Cost = "Costo";
$SelectEpisodes = "Seleziona gli eventi";
$Signature = "Firma";
$Token = "Buono";
$CertificateTool = "Certificazione";
$Score = "Punteggio";
$AdminManual = "Manuale dell\'Amministratore";
$DokeosProfessional = "Dokeos PRO";
$Settings = "Configurazione";
$Products = "Prodotti";
$Invoices = "Ricevute";
$SelectTrainer = "Seleziona l\'istruttore";
$SelectSession = "Seleziona la sessione";
$CourseAverageValues = "Media dei valori del corso";
$Learners = "Corsisti";
$ModulesTime = "Tempo dei moduli";
$ModulesProgress = "Avanzamento moduli";
$ModulesScore = "Punteggi moduli";
$QuizzesScore = "Punteggi quesiti";
$SelectCourses = "Seleziona il corso";
$ModulesAverageValues = "Valori medi modulo";
$InCourse = "Nel corso";
$Time = "Tempo";
$Progress = "Avanzamento";
$Quizzes = "Quesiti";
$SelectQuiz = "Seleziona il quesito";
$SelectType = "Seleziona la tipologia";
$SelfLearning = "Auto-apprendimento";
$ExamMode = "Modalità Esame";
$QuizzesAverageValues = "Valori medi quesiti";
$Quiz = "Test";
$AverageScore = "Valore medio";
$Highest = "Massimo";
$Lowest = "Minimo";
$Participation = "Partecipazione";
$AverageTime = "Tempo medio";
$ListLearners = "Elenco corsisti";
$SelectStatus = "Seleziona lo status";
$ActiveLearners = "Corsisti attivi";
$InActiveLearners = "Corsisti non attivi";
$QuizzesRanking = "Classifica quesiti";
$LearnersAverageValues = "Valori medi corsisti";
$LastName = "Cognome";
$FirstName = "Nome";
$LatestConnection = "Ultima connessione";
$IndividualReporting = "Report individuale";
$Active = "Attiva/o";
$InActive = "Inattiva/o";
$BackToList = "Torna all\'elenco";
$OverallInformation = "Informazioni generali";
$AccessDetails = "Dettagli accesso";
$SendMail = "Invia email";
$Status = "Status";
$Email = "Email";
$FirstConnection = "Primo accesso";
$TimeSpentInModules = "Tempo di accesso ai moduli";
$ScoreInModules = "Punteggio nei moduli";
$ProgressInModules = "Avanzamento nei moduli";
$QuizzesScore = "Punteggio nei quesiti";
$LoginToTheCourse = "Accedi al corso";
$Tutor = "Tutor";
$Screens = "Schermate";
$StandaloneQuiz = "Quesito autonomo";
$Attempts = "Tentativi";
$Answers = "Risposte";
$BackToQuiz = "Torna al quesito";
$AllAttempts = "Tutti i tentativi";
$BestAttempts = "Miglior tentativo";
$LatestAttempt = "Ultimo tentativo";
$UserNotSubscribed = "Utente non iscritto ad alcun corso";
$NoModules = "Nessun modulo";
$NoQuizzes = "Nessun quesito";
$Search = "Cerca";
$NoRecords = "Nessuna attività";
$BankInformation = "Coordinate bancarie";
$SelectInvoiceLogo = "Logo per la fattura";
$AdditionalInformation = "Informazioni aggiuntive";
$TitleEcommerce = "Titolo";
$CatalogName = "Voce del catalogo";
$DisplayCatalog = "Mostra il catalogo";
$DisplayImages = "Mostra le immagini";
$PaymentAccepted = "Forme di pagamento";
$CreditCardMessage = "Messaggio per la Carta di Credito";
$MessageWhenEndPayment = "Messaggio conclusivo della transazione";
$PaymentSection = "Pagamento";
$TermsAndConditionsComment = "Termini e condizioni";
$EcommerceVisibleCatalog = "Catalogo e-commerce visibile";
$EcommerceNameOfCategory = "Categoria";
$EcommerceAddCategoryProducts = "Aggiungi prodotti alla categoria";
$EcommerceCost = "Costo";
$EcommerceDuration = "Durata";
$EcommerceProfile = "Profilo";
$EcommercePreview = "Anteprima";
$EcommercePNGorJPGimages = "Immagini PNG o JPG";
$EcommerceRomeveImageAndWithoutImage = "Elimina l\'immagine";
$EcommerceDescription = "Descrizione";
$BackToModule = "Ritorna al modulo";
$BackToModuleList = "Ritorno all\'elenco dei moduli";
$CourseVsQuizScore = "Risultati dei quesiti dei corsi";
$ModuleVsQuizScore = "Risultati dei quesiti dei moduli";
$QuizVsQuizScore = "Risultato dei quesiti";
$UserVsQuizScore = "Risultati dei quesiti per utente";
$Action = "Azione";
$FacetofaceAverageValues = "Valori medi in presenza";
$Facetoface = "In presenza";
$MaxScore = "Punteggio massimo";
$BackToFacetoface = "Torna a \"in presenza\"";
$ScenarioOverview = "Sintesi scenario";
$MinScore = "Punteggio minimo";
$Import = "Importa";
$Import = "Importa";
$UserNameAlreadyExists = "Nome Utente già in uso";
$UserNameAlreadyExists = "Nome Utente già in uso";
$Unsubscribe = "Annulla l\'iscrizione";
$Address = "Indirizzo";
$Is = "è";
$FaceToFaceAverageValues = "Valori medi per le attività in presenza";
$UseFiltersToSelectReporting = "Usa i filtri posizionati superiormente per selezionare i dati";
?>