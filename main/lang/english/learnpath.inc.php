...
$StartModuleToolType = "How to start the module tool";
$LastItemChecked = "From the last item checked";
$AlwaysFirstItem = "Always from the first item";
?>