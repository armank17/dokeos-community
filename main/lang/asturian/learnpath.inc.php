...
$LpAddPage = "Crear documentu";
$LpSelectDocument = "Seleicionar documentu";
$LpLink = "Enllaz";
$LpAddQuiz = "Crear exerciciu";
$LpUploadQuiz = "Xubir exerciciu";
$LpSelectQuiz = "Seleicionar exerciciu";
$LpAssignment = "Xera";
$LpNewSurvey = "Nueva encuesta";
$CreateTheSurvey = "Amestar encuenta a la leición";
$AddSurveyToCourse  = "Amestar encuesta a la llección";
$LpNewAssignment = "Nueva xera";
$EditCurrentSurvey = "Editar la encuesta actual";
?>