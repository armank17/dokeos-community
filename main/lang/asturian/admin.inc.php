...
$ReadMoreLimitTitle = "Llímite \"Lleer más\"";
$ReadMoreLimitComment = "Esti llímite afitase dempués de cuántes pallabres de la llectura más, amosará l\'enllaz";
$AccessControlTitle = "Control d\'accesu ta activáu n\'Internet Explorer ";
$AccessControlComment = "El control d\'accesu puede frayar la restolación en Dokeos. Si la to organización lo usa, deberíes activar esta opción pa evitar estos problemes.";
$CalendarTypesTitle = "¿Qué eventos amuesense nel calendariu?";
$CalendarTypesComment = "El calendariu nun sólo puede amosar los eventos amestaos a la aplicación de calendariu, tamién puede amosar otra triba d\'información rellacionada col tiempu, como reuniones, eventos de plataforma, el concursu de la información de data, les data d\'asignación de caducidá, ..";
$AgendaDefaultViewTitle = "Vista por defeutu pal calendariu";
$AgendaDefaultViewComment = "El calendariu tien tres enfoques básicos: mes, selmana y día. ¿Qué amosar al acceder a la funcionalidá de calendariu?";
$MonthView = "Mes";
$WeekView = "Selmana";
$DayView = "Día";
$AgendaActionIconsTitle = "¿Amosar iconos d\'aición nel calendariu?";
$AgendaActionIconsComment = "Si los iconos d\'aición (editar, desaniciar, visibilidá, esportación) aparecen nel mes, selmana y vista diaria de l\'axenda? Estos iconos aparecen cuando te poses sobro un eventu.";
$ClickToEnableOrDisable = "Calca p\'activar o desactivar";
$CourseSettingDelegationFalseClickToTrue = "Esta configuración ye agora, non camudada pol alministrador del cursu. Calca equí pa camudala";
$CourseSettingDelegationTrueClickToFalse = "Esta configuración ye camudable pol alministrador del cursu. Calca equí pa camudalda";
$PlatformEvents = "Eventos plantaforma (Axenda global)";
$QuizEvents = "Eventos Quiz";
$SessionEvents = "Eventos sesión";
?>