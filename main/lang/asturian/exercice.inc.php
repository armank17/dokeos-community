...
$ExerciceExpiredTimeMessage = "Finó\'l tiempu pa la evaluación. Les entrugues respondíes serán consideraes na evaluación del exerciciu.";
$ExercisesTracking = "Exercicios de seguimientu";
$TrackingByQuestions = "Seguimientu por Entrugues";
$TrackingByQuestionsDescription = "Seguimientu por Entrugues Descripción";
$NumberOfAttempts = "Númberu d\'intentos";
$Scores = "Puntuaciones";
$AnsweredNothing = "Ensin Rempuesta";
$GoodAnswer = "Acertaes";
$WrongAnswer = "Fallaes";
$Percent = "Porcentaxe";
$QuizQuestionsPool = "Bancu d\'entrugues";
$FeedbackIfTrue = "Feedback si ye verdadero";
$FeedbackIfFalse = "Feedback si ye falso";
$Reasoning = "Razonamientu";
$QuizSelfEvaluationTitle = "Autoevaluación";
$QuizExamTitle = "Esame";
$QuizExamMessage = "Evalua y califica a los alumnos igual que nun esamen escritu";
$QuizSelfEvaluationMessage = "Los alumnos tienen práutica y prueba les habilidaes";
$AddToQuiz = "Amestar al exerciciu";
$Prerequisite = "Pre-requisitu";
$Beginner = "Básicu";
$Intermediate = "Intermediu";
$Expert = "Espertu";
$LeftSet = "Conxuntu a manzorga";
$RightSet = "Conxuntu a drecha";
$OpenAnswer = "Rempuesta abierta";
