...
*/
$MyTasks = "Mes articles";
$FavoriteBlogs = "Mes blogs";
...
$Rate = "Note";
$Roles = "Rôles";
$AddTask = "Nouveau rôle";
$AddTasks = "Nouveau rôle";
$AssignTask = "Assigner un rôle";
$AssignTasks = "Assigner rôles";
