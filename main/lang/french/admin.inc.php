...
$ExtendRightsForCoachTitle = "Donner des droits étendus aux tuteurs";
...
$AgendaActionIconsComment = "Les icônes d\'action (édition, suppression, la visibilité, l\'exportation) doivent apparaître dans les affichages mois, semaine et jour du calendrier ? Ces icônes apparaissent lors du survol d\'un événement.";
$ClickToEnableOrDisable = "Cliquer pour activer ou désactiver";
$CourseSettingDelegationFalseClickToTrue = "Ce paramètre n\'est pas modifiable maintenant par l\'administrateur du cours. Cliquez si vous voulez changer cela. ";
$CourseSettingDelegationTrueClickToFalse = "Ce paramètre est modifiable maintenant par l\'administrateur du cours. Cliquez si vous voulez changer cela. ";
...
$CasUserAddLoginAttributeComment = "Le champ XML du ticket CAS contenant le login de l\'utilisateur";
$CasUserAddEmailAttributeTitle = "Champ XML pour l\'email utilisateur";
$CasUserAddEmailAttributeComment = "Le champ XML du ticket CAS contenant le courriel de l\'utilisateur";
$CasUserAddFirstnameAttributeTitle = "Champ XML pour le prénom";
$CasUserAddFirstnameAttributeComment = "Le champ XML du ticket CAS contenant le prénom d\'utilisateur";
$CasUserAddLastnameAttributeTitle = "Champ XML prénom";
$CasUserAddLastnameAttributeComment = "Le champ XML du ticket CAS contenant le nom d\'utilisateur";
...
$CaptchaComment = "Un Captcha est une vérification insérée dans un formulaire pour s\'assurer que les réponses ne sont pas générées par un ordinateur. L\'objectif est d\'éviter les problèmes de spam.";
...
$DefaultInvitationContent = "Puis-je vous contacter lorsque vous êtes en ligne sur";
$ShowForcePasswordChangeTitle = "Montrer la fonctionnalité pour forcer mot de passe";
...
$AllowUserEditAgendaTitle = "Les utilisateurs peuvent gérer le calendrier?";
...
$ServiceVisioTitle = "Vidéoconférence";
...
$WidgetHomepageComment = "Quelle disposition souhaitez-vous pour le widget de la page d\'accueil ?";
...
$Quizfailure = "Vous avez échoué dans le quiz";
...
$EditSuperAdmins = "Modifier les super-administrateurs";
$Catalogue = "Catalogue";
$Topics = "Domaines";
...
$PRO = "PRO";
$Import = "Importer";
$AddSlides = "Ajouter une slide";
$AltText = "Texte alternatif";
$Caption = "Sous-titre";
$DefaultImagesize = "PNG ou JPG images, 240x720 pixels";
$SlidesManagement = "Glisseur";
$SlidesList = "Liste des diapositives";
$Picture = "Image";
$YourTitle1 = "Votre Titre 1";
$YourTitle2 = "Votre Titre 2";
$YourTitle3 = "Votre Titre 3";
$YourCaption1 = "Votre Sous-titre 1";
$YourCaption2 = "Votre Sous-titre 2";
$YourCaption3 = "Votre Sous-titre 3";
$AltText1 = "Texte alternatif 1";
$AltText2 = "Texte alternatif 2";
$AltText3 = "Texte alternatif 3";
$SlideScenario = "Scénario de glisseur";
$ShowSlide = "Afficher glisseur ";
$SlideSpeed = "Vitesse diapositives";
$dokeos2_tablet = "Gris tablet";
$dokeos2_blue_tablet = "Bleu tablet";
$dokeos2_medical_tablet = "Médical tablet";
$dokeos2_red_tablet = "Rouge tablet";
$dokeos2_black_tablet = "Noir tablet";
$UseDefaultEditorTitle = "Sélectionnez l\'éditeur en ligne pour votre portail";
$UseDefaultEditorComment = "Actuellement, nous vous encourageons à utiliser l\'éditeur FCK, le nouvel éditeur CK en ligne est en phase de développement.";
$CkEditorInfo = "Editeur CK";
$FckEditorInfo = "Editeur FCK";
$dokeos2_orange_tablet = "Orange tablet";
$EnrollmentToHumanResourceManagerAtRegistrationToPortal = "Assigner au Superviseur";
$AutomaticRegistrationHumanResourceManager = "Assigner tous les utilisateurs du portail au Superviseur";
$HumanResourceManagerList = "Liste de Superviseurs";
$DefaultHumanResourceManager = "Gestion des RH";
$ThereIsNoADefaultHRMAssignedAddOneOnTopList = "Le superviseur principal n\'a pas encore été assigné";
$TabsSearch = "Onglet Recherche";
$DokeosProFeaturesAuthor = "Auteur";
$EnablePlatformChatTitle = "Activer le chat dans la plate-forme ensemble";
$EnablePlatformChatComment = "Permettre à activer le chat dans toutes les pages du portail";
$DisablePlatformChat = "Desactivé";
$EnablePlatformChat = "Activé";
$PlatformChatRequestTitle = "Demandes de chat dans le portail";
$PlatformChatRequestComment = "Permettre d\'attribuer la valeur par défaut en secondes que le chat utilisera pour faire des demandes au serveur";
$ServiceVisioComment = "Activer l\'outil de Vidéoconférence";
$ServicePpt2lpTitle = "Oogie";
$ServicePpt2lpComment = "Activer l\'outil Oogie";
$SearchEnabledTitle = "Moteur de recherche";
$SearchEnabledComment = "Activer la fonctionnalité de moteur de recherche";
$DokeosProFeaturesLms = "LMS";
$DokeosProFeaturesEvaluate = "Évaluer";
$DokeosProFeaturesShop = "Boutique";
$DokeosProFeaturesLive = "Live";
$DokeosProFeaturesWebTv = "WebTV";
$ShowForcePasswordChangeTitleComment = "Activer tous les filtres de mots de passe comme longueur, les règles de mot de passe. changer après la première connexion, etc";
$LogoUrlTitle = "Logo URL ";
$LogoUrlComment = "L\'adresse web du logo (le lien apparaît sur le logo à gauche)";
...
$Signature = "Signature";
$Token = "Jeton";
$CertificateTool = "Outil Certificate";
$Score = "Score";
$AdminManual = "Manuel de l\'Admin";
$DokeosProfessional = "Dokeos PRO";
$Settings = "Paramètres";
$Products = "Produits";
$Invoices = "Factures";
$SelectTrainer = "Sélectionnez Formateur";
$SelectSession = "Sélectionnez la Session";
$CourseAverageValues = "Valeurs moyennes de cours";
$Learners = "Apprenants";
$ModulesTime = "Temps des Modules";
$ModulesProgress = "Progrès des Modules";
$ModulesScore = "Score des Modules";
$QuizzesScore = "Score du quizz";
$SelectCourses = "Sélectionnez le cours";
$ModulesAverageValues = "Valeurs moyennes de module";
$InCourse = "En cours";
$Time = "Temps";
$Progress = "Progrès";
$Quizzes = "Quizz";
$SelectQuiz = "Sélectionnez Quiz";
$SelectType = "Sélectionnez le Type";
$SelfLearning = "Auto-apprentissage";
$ExamMode = "Mode d\'examen";
$QuizzesAverageValues = "Valeurs moyennes de quiz";
$Quiz = "Quiz";
...
$ListLearners = "Liste des apprenants";
$SelectStatus = "Sélectionnez l\'État";
$ActiveLearners = "Apprenants actifs";
$InActiveLearners = "Apprenants inactifs";
$QuizzesRanking = "Classement des quiz";
$LearnersAverageValues = "Valeurs moyennes pour les apprenants";
$LastName = "Nom";
$FirstName = "Prénom";
$LatestConnection = "Dernière connexion";
$IndividualReporting = "Suivi Individu";
$Active = "Active";
$InActive = "Inactif";
$BackToList = "Retour à la liste";
$OverallInformation = "Information globale";
$AccessDetails = "Détails d\'accès";
$SendMail = "Envoyer Mail";
$Status = "Statut";
$Email = "Courriel";
$FirstConnection = "Première connexion";
$TimeSpentInModules = "Temps passé dans Modules";
$ScoreInModules = "Score dans Modules";
$ProgressInModules = "Progrès dans Modules";
$QuizzesScore = "Score de quiz";
$LoginToTheCourse = "Se connecter sur le cours";
$Tutor = "Tuteur";
$Screens = "Écrans";
$StandaloneQuiz = "Quiz autonome";
$Attempts = "Tentatives";
$Answers = "Réponses";
$BackToQuiz = "Retour au Quiz";
$AllAttempts = "Toutes les tentatives";
$BestAttempts = "La meilleure tentative";
$LatestAttempt = "Dernière tentative ";
$UserNotSubscribed = "Vous n\'êtes inscrit à aucun cours";
$NoModules = "Pas de Modules";
$NoQuizzes = "Pas de Quizz";
$Search = "Chercher";
$NoRecords = "Aucun enregistrement";
$BankInformation = "Information banquaire";
$SelectInvoiceLogo = "Logo de la facture";
$AdditionalInformation = "Informations supplémentaires";
$TitleEcommerce = "Nom";
$CatalogName = "Nom du catalogue";
$DisplayCatalog = "Afficher le catalogue";
$DisplayImages = "Afficher les images";
$PaymentAccepted = "Paiements acceptés";
$CreditCardMessage = "Message pour les cartes de crédit";
$MessageWhenEndPayment = "Message lors de la validation du paiement";
$PaymentSection = "Étape du paiement";
$TermsAndConditionsComment = "Conditions générales de vente";
$EcommerceVisibleCatalog = "Afficher dans le catalogue";
$EcommerceNameOfCategory = "Nom de la catégorie";
$EcommerceAddCategoryProducts = "Ajouter une catégorie";
$EcommerceCost = "Prix";
$EcommerceDuration = "Accès";
$EcommerceProfile = "Dans le catalogue";
$EcommercePreview = "Aperçu";
$EcommercePNGorJPGimages = "Images JPG ou PNG";
$EcommerceRomeveImageAndWithoutImage = "Supprimer l\'image";
$EcommerceDescription = "Description";
$BackToModule = "Retourner au module";
$BackToModuleList = "Retourner à la liste des modules";
$CourseVsQuizScore = "Résultat des quiz";
$ModuleVsQuizScore = "Résultat des quiz des modules";
$QuizVsQuizScore = "Résultat du quiz";
$UserVsQuizScore = "Résultats des apprenants aux quiz";
$Action = "Action";
$FacetofaceAverageValues = "Des valeurs moyennes en face-à-face";
$Facetoface = "Face-à-face";
$MaxScore = "Score maximum";
$BackToFacetoface = "Retour au face-à-face";
$ScenarioOverview = "Scénario";
$MinScore = "Score minimum";
$UserNameAlreadyExists = "L\'utilisateur existe déjà ";
$UserNameAlreadyExists = "L\'utilisateur existe déjà ";
$Address = "Adresse";
$Is = "est";
$FaceToFaceAverageValues = "Valeurs moyennes pour les activités en face-à-face";
$UseFiltersToSelectReporting = "Utilisez les filtres en haut de l\'écran pour afficher des données";
?>