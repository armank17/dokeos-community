...
$LpNewWindowInterfaceMode = "Ouvrir une nouvelle fenêtre (modules Flash)";
$LpSelectDefaultCourseInterfaceFixed = "Dokeos navigation (hauteur fixe)";
$StartModuleToolType = "Comment démarrer l\'outil de module";
$LastItemChecked = "Depuis la dernière page visitée";
$AlwaysFirstItem = "Toujours depuis la première page";
?>