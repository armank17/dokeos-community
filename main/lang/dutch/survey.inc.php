...
*/
$PublishSurvey = "Publiceer enquête";
$CompareQuestions = "Vergelijk vragen";
$InformationUpdated = "Informatie aangepast";
...
$SurveyPreview = "Enquete voorbeeldweergave";
...
$IdenticalSurveycodeWarning = "De enquêtecode bestaat reeds. Dit betekent vermoedelijk dat de enquête al bestaat in één of meer andere talen. Uitgenodigde gebruikers zullen kiezen tussen de verschillende talen.";
$ThisSurveyCodeSoonExistsInThisLanguage = "Deze enquêtecode bestaat reeds in deze taal";
$SurveyUserAnswersHaveBeenRemovedSuccessfully = "De antwoorden van de gebruiker op deze enquête werden succesvol verwijderd.";
...
$PleaseChooseACondition = "Gelieve een voorwaarde te kiezen";
$ChooseDifferentCategories = "Kies verschillende categorieën";
$Version = "Versie";
$Normal = "Normaal";
$NoLogOfDuration = "Geen historiek van tijdsduur";
$AutoInviteLink = "Gebruikers die niet uitgenodigd zijn kunnen deze link gebruiken om de enquete te doen:";
$CompleteTheSurveysQuestions = "Vul de vragen van de enquête in";
$SurveysDeleted = "Enquêtes verwijderd";
...
$BackToSurvey = "Terug naar enquête";
$UpdateInformation = "Pas informatie aan";
$PleaseFillSurvey = "Gelieve de enquête in te vullen";
$ReportingOverview = "Rapportenoverzicht";
$ThereAreNotQuestionsForthisSurvey = "Er zijn geen vragen aan deze enquête verbonden";
$MChoice = "Meerkeuze";
