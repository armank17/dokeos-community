...
$CourseUsers = "Gebruikers in cursus";
$PostsNumber = "Aantal berichten";
$NumberOfPostsForThisUser = "Aantal berichten voor deze gebruiker";
$AveragePostPerUser = "Berichten van deze gebruiker";
$QualificationChangesHistory = "Beoordeling verandert geschiedenis";
$MoreRecent = "meer recent";
$Older = "ouder";
$OrderBy = "sorteer op";
$WhoChanged = "Wie gewijzigd";
$NoteChanged = "Notitie gewijzigd";
$DateChanged = "Datum gewijzigd";
$ViewComentPost = "Bekijk commentaren op de berichten";
$AllStudents = "Alle leerlingen";
$StudentsQualified = "Gekwalificeerde leerlingen";
$StudentsNotQualified = "Ongekwalificeerde leerlingen";
$NamesAndLastNames = "Namen en achternamen";
$MaxScore = "Score";
$QualificationCanNotBeGreaterThanMaxScore = "Cijfer kan max score niet overschrijden";
$ThreadStatistics = "Statistieken van de discussie";
$Thread = "Discussie";
$NotifyMe = "Hou me op de hoogte";
$ConfirmUserQualification = "Bevestig cijfer";
$NotChanged = "Ongewijzigd";
$TitleColumnGradebook = "Kolomhoofd in Competentie Rapport";
$QualifyThreadGradebook = "Markeer deze discussie";
$QualifyWeight = "Gewicht in Rapport";
$QualifyNumeric = "Score";
$AlterQualifyThread = "Bewerk discussie score";
$ForumMoved = "De forum is verwijderd";
$YouMustAssignWeightOfQualification = "U dient een score te geven aan deze activiteit";
$DeleteAttachmentFile = "Verwijder aangehecht bestand";
$EditAnAttachment = "Wijzig een bijlage";
$SeeForum = "Zie forum";
$CreateForum = "Creëer forum";
$ModifyForum = "Bewerk forum";
$CreateThread = "Creëer discussie";
...
$ForumcategoryLocked = "Forum categorie afgesloten";
$ThereAreNoForumsInThisCategory = "Geen forums in deze categorie";
?>