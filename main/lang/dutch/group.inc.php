...
$langGroupSelfRegistration = "Registratie";
...
$ProceedToCreateGroup = "Ga verder om groep(en) aan te maken ";
...
$EditGroupCategory = "Pas groepscategorie aan";
$GroupCalculator = "Groep calculator";
$DeleteGroup = "Groep(en) verwijderen";
$GroupAvailablePlaces = "Beschikbare plaatsen";
$SaveGroups = "Groep(en) opslaan";
$GroupScenarioCollaboration = "Samenwerken";
$GroupScenarioCompetition = "Competitie";
$SelectThisScenario = "Selecteer dit scenario";
$GroupsOf = "Groepen van";
$GroupUsers = "Groep gebruikers";
$GroupCategoryName = "Groep categorie naam";
$GroupScenarioCollaborationDescription = "Groep scenario";
$GroupScenarioCompetition = "Competitie";
$PublicPrivateGroup = "Groep";
$NoGroupToolsAvailable = "Geen groepen";
$GroupStudentRegistrationDenied = "Registratie niet toegelaten";
$Seats = "plaatsen";
$GroupCategories = "Scenario";
$GroupsPerUser = "Groepeer naar gebruiker";
$NoCategory = "Geen categorie";
$JoinGroup = "Bij groep aansluiten";
$GroupMembership = "Groep lidmaatschap";
$Tutoring = "Begeleiding";
$Collaboration = "Samenwerking";
$Competition = "Competitie";
$ScenarioText1 = "Leerlingen hebben alleen interactie met de mentor. Geen interactie tussen leerlingen.";
$ScenarioText2 = "Leerlingen hebben interactie met de mentor en met elkaar. En ze kunnen andere groepswerkstukken zien (maar niet wijzigen).";
$ScenarioText3 = "Leerlingen hebben interactie met de mentor en met elkaar. En ze kunnen andere groepswerkstukken niet zien.";
$ScenarioTools1 = "Functionaliteiten: Opdrachten + Privé email";
$ScenarioTools2 = "Functionaliteiten: Opdrachten + Privé email + Chat + Forum + Document + Wiki";
$ScenarioTools3 = "Functionaliteiten: Opdrachten + Privé email + Chat + Forum + Document + Wiki";
$NewGroupCreated = "Nieuwe Groep automatisch gecreëerd om ruimte te geven aan nieuwe gebruiker";
$GroupChat = "Chat";
?>