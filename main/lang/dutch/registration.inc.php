...
$CurrentPasswordEmptyOrIncorrect = "Het huidige wachtwoord is incorrect";
$password_request = "U heeft gevraagd om uw wachtwoord te resetten. Indien u dit niet gedaan heeft, negeer deze mail.Om uw wachtwoord te resetten, klik op de resetlink.";
...
$langProblem = "In geval van problemen kunt u met ons contact opnemen.";
$langIs = "is";
...
$PasswordEncryptedForSecurity = "Uw wachtwoord is geëncrypteerd vanwege beveiligingsredenen. Na het klikken op de link wordt opnieuw een e-mail verstuurd met uw wachtwoord.";
...
$UserAlreadyRegisterByOtherCreator = "De gebruiker werd reeds ingeschreven door een andere coach";
$UserCreatedPlatform = "Gebruiker aangemaakt in het portaal";
$UserInSession = "Gebruiker toegevoegd aan sessie";
$UserNotAdded = "Gebruiker niet toegevoegd";
$NoSessionId = "De sessie kon niet geidentifieerd worden";
$NoUsersRead = "Gelieve uw XML/CSV bestand te controleren";
$UserImportFileMessage = "Als in het XML/CVS bestand de logins missen, zullen de voor- en achternaam worden samengevoegd om een login te creëren, vb Julio Montoya wordt jmontoya";
$UserAlreadyRegisteredByOtherCreator = "De gebruiker werd reeds ingeschreven door een andere coach";
$NewUserInTheCourse = "Nieuwe gebruiker in cursus";
$MessageNewUserInTheCourse = "Er werd een nieuwe gebruiker ingeschreven in de cursus";
$EditNormalProfile = "Pas profiel aan";
$EditExtendProfile = "Pas uitgebreid profiel aan";
$EditInformation = "Pas profiel aan";
$RegisterUser = "Registreer";
$IHaveReadAndAgree = "Ik heb gelezen en ingestemd met de ";
$ByClickingRegisterYouAgreeTermsAndConditions = "Door op \"Registreren\" te klikken gaat u akkoord met de Voorwaarden en Condities";
$User = "Gebruiker";
$LostPass = "Wachtwoord vergeten ?";
$EnterEmailUserAndWellSendYouPassword = "Voer uw e-mailadres in om een nieuw wachtwoord te genereren.";
$NoUserAccountWithThisEmailAddress = "Er bestaat geen account voor deze gebruiker en/of dit e-mailadres.";
$WithTheFollowingSettings = "met de volgende instellingen:";
$IncorrectCaptcha = "De bevestigingscode is niet correct";
$CaptchaCheck = "Bevestigingscode";
$CaptchaCheckExplanation = "U dient de bevestigingscode zoals hierboven afgebeeld in te geven.";
$CouldNotResetPassword = "Kan wachtwoord niet terugstellen";
$ALinkToRecoverYourPasswordHasBeenSentToYourEmailAddress = "Er is een link naar uw e-mailadres verzonden waarmee u een nieuw wachtwoord kunt genereren.";
?>