...
$langMultipleUsernameAndPassword = "Accounts met dezelfde <i>Gebruikersnaam</i> <b>en</b> hetzelfde <i>wachtwoord</i>";
...
$Duration = "Duur";
$WrongDatasForTimeSpentOnThePlatform = "De data van deze gebruiker werd geregistreerd toen de calculatie van tijd besteed op het platform niet mogelijk was.";
...
$ChatConnectionsDuringLastXDays = "Connecties met de chat gedurende %s dagen";
$ChatLastConnection = "Laatste chat connectie";
$CourseInformation = "Training informatie";
$NoAdditionalFieldsWillBeExported = "De extra velden worden niet geëxporteerd";
$langSendNotification = "Informeren";
$TimeOfActiveByTraining = "Tijd in training";
$AvgAllUsersInAllCourses = "Gemiddelde van alle studenten in alle cursussen voor deze training";
$AvgExercisesScore = "Testen score";
$TrainingTime = "Tijd";
$CourseProgress = "Voortgang";
$ViewMinus = "Bekijk minus";
$ResourcesTracking = "Rapportering van middelen";
...
$Traffic = "Verkeer";
$TrackTrainings = "Trainingen";
$TrackSessions = "Sessies";
$CompareUsersOnLearnpath = "Gebruikers in cursus vergelijken";
?>