...
$EditGroupCategory = "Modificar a categoria do grupo";
$GroupCalculator = "Calculadora do grupo";
$DeleteGroup = "Excluir grupo(s)";
$GroupAvailablePlaces = "Fixar";
$SaveGroups = "Validar";
$GroupScenarioCollaboration = "Colaboração";
$GroupScenarioCompetition = "Competição";
$SelectThisScenario = "Selecione este cenário";
$GroupsOf = "Grupos de";
$GroupUsers = "Usuários do grupo";
$GroupCategoryName = "Nome da categoria do grupo";
$GroupScenarioCollaborationDescription = "Cenário do grupo";
$GroupScenarioCompetition = "Competição";
$PublicPrivateGroup = "Privado";
$NoGroupToolsAvailable = "Nenhum grupo";
$GroupStudentRegistrationDenied = "Registro negado";
$Seats = "assentos";
$GroupCategories = "Cenário";
$GroupsPerUser = "Grupos pelo usuário";
