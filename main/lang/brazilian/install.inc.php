...
$langInstituteShortName  = "Mome fantasia da sua organização";
...
$langAllowSelfRegProf  = "Permitir auto-registro para criar cursos";
$langEG = "ex.";
...
$langCfgSetting = "Parâmetros";
$langDBSetting = "Configurações da BD MySQL";
...
$CheckDatabaseConnection = "Testar conexão com BD";
$PrintOverview = "Resumo da Instalação";
$Installing = "Instalar";
$of = "de";
$Step = "Passo";
$Of = "de";
...
$ServerRequirementsInfo = "Bibliotecas e funcionalidades que o servidor deve possuir para poder usar o Dokeos com todas as suas extensões";
...
$DirectoryAndFilePermissionsInfo = "Alguns diretórios (pastas) e arquivos neles incluídos devem permitir a escrita pelo servidor web para que o Dokeos possa funcionar corretamente (arquivos enviados pelos estudantes, página html de entrada, ...). Esta operação de alteração das características (escrita / não escrita) dos diretórios e arquivos pode implicar uma alteração manual no próprio servidor (fora portanto desta interface).";
...
$OldVersionRootPath = "Caminho da BD da versão antiga";
...
$InstallationStep1Help = "Instalação do Dokeos, passo 1: instalação do idioma";
$InstallationStep2Help = "Instalação do Dokeos passo 2: requisitos";
$InstallationStep3Help = "Instalação do Dokeos passo 3: licença";
$InstallationStep4Help = "Instalação do Dokeos passo 4: configuração do banco de dados MySQL";
$InstallationStep5Help = "Instalação do Dokeos passo 5: Configuração do ambiente";
$InstallationStep6Help = "Instalação do Dokeos passo 6: Última verificação antes da instalação";
$InstallationInstallationProcessHelp = "Processo de instalação do Dokeos";
$Up2DateManualDokeosCom = "Para mais informações leia o manual de instalação em http://www.dokeos.com";
$MysqlConnectionOk = "Conexão com o MySQL é ok";
$ApplySettingsToGroups = "Padrão";
$IfStillTypingPleaseContinue = "Se ainda está digitando por favor, continue";
$UpgradeFromDokeos20x = "Upgrade 2.x do portal";
?>