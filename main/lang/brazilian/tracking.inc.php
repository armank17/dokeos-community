...
$SelectFieldToAdd = "Selecione um campo do perfil do usuário para adicionar";
$AddAdditionalProfileField = "Adicionar campo no perfil do usuário";
$LastAttempt = "Última tentativa";
$Traffic = "Tráfego";
$TrackTrainings = "Cursos";
$TrackSessions = "Sessões";
$CompareUsersOnLearnpath = "Compare os usuários do curso";
?>