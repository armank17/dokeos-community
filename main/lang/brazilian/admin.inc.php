...
$ShowBackLinkOnTopOfCourseTreeComment = "Mostrar um link para voltar à hierarquia do curso. De qualquer modo um link para voltar estará sempre disponível ao final da lista.";
$langUsed       = "utilizado";
$langPresent   = "Ok";
...
$langNomOutilTodo = "Gerenciar lista de feedback";
...
$langVisioconfDescription = "<strong>Dokeos Live Conferencing®  é uma ferramenta standard de videconferência que oferece:</strong><br/>projeção de dispositivo, quadro para desenhar e escrever, possibilidade de conversas utilizando audio/video. Requer o player do Flash® e permite usar três modos: um para um, um para muitos e muitos para muitos.";
...
$ShowForcePasswordChangeTitle = "Visualizar o recurso de forçar a senha";
...
$CreatePageFromATemplate = "Criar uma página do modelo";
...
$Quizfailure = "Você fracassou no teste";
...
$ServicePpt2lpComment = "Ativar a ferramenta Oogie";
$SearchEnabledTitle = "Motor de busca";
$SearchEnabledComment = "Ativar o recurso motor de busca";
$DokeosProFeaturesLms = "Lms";
$DokeosProFeaturesEvaluate = "Avaliar";
$DokeosProFeaturesShop = "Shop";
$DokeosProFeaturesLive = "Ao vivo";
$DokeosProFeaturesWebTv = "Web TV";
$ShowForcePasswordChangeTitleComment = "Permitir limitar as tentativas máximas no processo de registro";
$LogoUrlTitle = "Logotipo da URL";
$LogoUrlComment = "O logotipo da instituição (link que aparece no cabeçalho à direita)";
...
$Cost = "Custo";
$SelectEpisodes = "Escolha os episódios";
$Signature = "Assinatura";
$Token = "Token";
$CertificateTool = "Ferramenta de certificado";
$Score = "Score";
$AdminManual = "Manual do Administrador";
$DokeosProfessional = "Dokeos PRO";
$Settings = "Configurações";
$Products = "Produtos";
$Invoices = "Recibos";
$SelectTrainer = "Selecione o instrutor";
$SelectSession = "Selecione a sessão";
$CourseAverageValues = "Média de valores do curso";
$Learners = "Tutores";
$ModulesTime = "Módulos de Tempo";
$ModulesProgress = "Módulos de Progresso";
$ModulesScore = "Módulos de Score";
$QuizzesScore = "Score dos Testes";
$SelectCourses = "Selecione o Curso";
$ModulesAverageValues = "Valores médios dos módulos";
$InCourse = "Em Curso";
$Time = "Tempo";
$Progress = "Progresso";
$Quizzes = "Testes";
$SelectQuiz = "Selecione o teste";
$SelectType = "Selecione o Tipo";
$SelfLearning = "E-Learning";
$ExamMode = "Modo de exame";
$QuizzesAverageValues = "Valores Médios do Questionário";
$Quiz = "Teste";
...
$ListLearners = "Lista de Aprendizes";
$SelectStatus = "Selecione o Status";
$ActiveLearners = "Aprendizes Ativos";
$InActiveLearners = "Aprendizes Inativos";
$QuizzesRanking = "Ranking dos Testes";
$LearnersAverageValues = "Média de Valores dos Aprendizes";
$LastName = "Sobrenome";
$FirstName = "Nome";
$LatestConnection = "Última Conexão";
$IndividualReporting = "Relatório individual";
$Active = "Ativo";
$InActive = "Inativo";
$BackToList = "Voltar à lista";
$OverallInformation = "Informações Gerais";
$AccessDetails = "Detalhes de Acesso";
$SendMail = "Enviar Email";
$Status = "Status";
$Email = "Email";
$FirstConnection = "Primeira Conexão";
$TimeSpentInModules = "Tempo Gasto nos Módulos";
$ScoreInModules = "Score nos Módulos";
$ProgressInModules = "Progresso nos Módulos";
$QuizzesScore = "Score dos Testes";
$LoginToTheCourse = "Acessar o Curso";
$Tutor = "Tutor";
$Screens = "Telas";
$StandaloneQuiz = "Teste independente";
$Attempts = "Tentativas";
$Answers = "Respostas";
$BackToQuiz = "Voltar ao Questionário";
$AllAttempts = "Todas as Tentativas";
$BestAttempts = "Melhor Tentativa";
$LatestAttempt = "Última Tentativa";
$UserNotSubscribed = "Usuário não registrados em menhum curso";
$NoModules = "Nenhum módulo";
$NoQuizzes = "Nenhum teste";
$Search = "Pesquisa";
$NoRecords = "Sem Registos";
$BankInformation = "Informações do Bancárias";
$SelectInvoiceLogo = "Selecione o logótipo da fatura";
$AdditionalInformation = "Informações Adicionais";
$TitleEcommerce = "Título";
$CatalogName = "Nome do Catálogo";
$DisplayCatalog = "Mostrar catálogo";
$DisplayImages = "Mostrar Imagens";
$PaymentAccepted = "Pagamento Aceito";
$CreditCardMessage = "Mensagem do Cartão de Crédito";
$MessageWhenEndPayment = "Mensagem para o final do pagamento";
$PaymentSection = "Seção de Pagamento";
$TermsAndConditionsComment = " Comentário Termos e Condições";
$EcommerceVisibleCatalog = "Ecommerce catálogo visível";
$EcommerceNameOfCategory = "Nome da categoria";
$EcommerceAddCategoryProducts = "Adicionar produtos a categoria";
$EcommerceCost = "Preço";
$EcommerceDuration = "Duração";
$EcommerceProfile = "Perfil";
$EcommercePreview = "Visualização";
$EcommercePNGorJPGimages = "Imagem PMG OU JPG";
$EcommerceRomeveImageAndWithoutImage = "Excluir imagem";
$EcommerceDescription = "Descrição";
$BackToModule = "Voltar ao Módulo";
$BackToModuleList = "Voltar a Lista de Módulos";
$CourseVsQuizScore = "Cursos Pontuação do Teste";
$ModuleVsQuizScore = "Módulo Pontuação dos Teste";
$QuizVsQuizScore = "Pontuação do Teste";
$UserVsQuizScore = "Pontuação do Teste do Usuário";
$Action = "Ação";
?>