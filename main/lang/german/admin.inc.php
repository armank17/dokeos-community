...
$ForcePasswordChangeComment = "Nach wievielen Anmeldungen muss das Passwort gewechselt werden ?Dies erhöht die Sicherheit der Benutzer.Wenn Sie nicht wollen, dass das Passwort nach x Anmeldungen neu gesetzt werden muss, dann tragen Sie eine Null (0) ein.";
...
$ShowTutorDataTitle = "Datum des letzten Logins des Dozenten in der Fussliste eintragen.";
$ShowTutorDataComment = "Anzeigen der Kontaktinformationen des Dozenzen (Name und E-Mail wenn hinterlegt) in der Fussliste.";
$ShowTeacherDataTitle = "Zeige Informationen zum Lehrer in der Fusszeile.";
$ShowTeacherDataComment = "Zeigt die Kontaktdaten des Lehrers (Name und E-Mail wenn hinterlegt) in der Fusszeile an.";
$TermsAndConditions = "Bedingungen & Abmachungen";
$DisplayTermsConditions = "Anzeigen der Bedingungen und Abmachungen (AGB\'s) in der Registrierungsseite.Somit müssen Benutzer die AGB\'s akzeptieren um zu registrieren.";
$AllowTermsAndConditionsTitle = "Aktivieren der Bedingungen und Abmachungen (AGB\'s)";
$AllowTermsAndConditionsComment = "Diese Option erlaubt es Ihnen, die Bedingungen und Abmachungn (AGB\'s) auf der Registrierungsseite für neue Benutzer anzuzeigen.";
$Load = "Laden";
$AllVersions = "Alle Versionen";
$EditTermsAndConditions = "Ändern der Bedingungen und Abmachungen (AGB\'s)";
$Changes = "Änderungen";
$TermAndConditionNotSaved = "Bedingungen und Abmachungen (AGB\'s) nicht gespeichert.";
$TheSubLanguageHasBeenRemoved = "Die sekundäre Sprache wurde gelöscht";
$AddTermsAndConditions = "Hinzufügen der Bedingungen und Abmachungen (AGB\'s)";
$TermAndConditionSaved = "Bedingungen und Abmachungen (AGB\'s) gespeichert.";
$Visibility = "Sichtbarkeit";
$SessionCategory = "Programm";
$AddSessionCategory = "Kategorie hinzufügen";
$SessionCategoryName = "Name der Kategorie";
$EditSessionCategory = "Programm bearbeiten";
$Username = "Benutzername";
$mycourses_menu = "Meine Kurse: Menü";
$header = "Kopfzeile";
$footer = "Fusszeile";
$DetailView = "Detailsübersicht der Kalendereinträge";
$CalendarNavigationDefault = "Als Teil des Kalenders";
$CanUsersMangeGroupAgendaTitle = "Können Benutzer den Gruppenkalender führen ?";
?>