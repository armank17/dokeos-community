...
$SpecialLetMeSelectItems = "Posebno: omogoči mi izbrati elemente";
$CreateBackup = "Ustvari rezervno kopijo";
$AllowCoachsToEditInsideTrainingSessions = "Dovoli uporabnikom tipa coach urejanje vsebovanih učnih sej";
$AllowCoachsToEditInsideTrainingSessionsComment = "Dovoli uporabnikom tipa coach urejaje komentarjev vsebovanih učnih sej";
$ShowSessionDataTitle = "Prikaži naslov podatkov seje";
$ShowSessionDataComment = "Prikaži komentar podatkov seje";
$SubscribeSessionsToCategory = "Določi kategorijo k seji";
$SessionListInPlatform = "Seznam sej platforme";
$SessionListInCategory = "Seznam sej v kategorijah";
$ToExportSpecialSelect = "Če želite izvoz tečajev z vsebovanimi sejami, ki bo zagotovil da bodo seje vključene, morate vsako posamezno izmed njih izbrati s seznama. ";
$ErrorMsgSpecialExport = "Tu ni registriranih tečajev ali pa ti nimajo povezave s sejami";
$ConfigureInscription = "Nastavite registracijske strani";
$MsgErrorSessionCategory = "Izberite kategorijo in sejo";
$NumberOfSession = "Število sej";
$DeleteSelectedSessionCategory = "Odstrani golj izbrane kategorije brez sej";
$DeleteSelectedFullSessionCategory = "Odstrani izbrane kategorije določene s sejami";
...
$ShowGlossaryInExtraToolsComment = "Od tu lahko nastavite način dodajanaj terminov slovarja v dodatnih orodjih, kot so učne poti, testi/vaje, ...";
$FieldTypeTag = "Oznaka uporabnika";
$SendEmailToAdminTitle = "E-poštno obvestilo ob kreiranju novega tečaja";
$SendEmailToAdminComment = "Pošlji epoštno obvestilo uravitelju platforme vsakič, ko poljuben učitelj ustvari nov tečaj";
$UserTag = "Uporabniška oznaka";
...
$MoreButtonsForMaximizedModeTitle = "Razširitev orodne vrstice";
$MoreButtonsForMaximizedModeComment = "Omogoči razširitev orodne vrstice z gumbi, ko je WYSIWYG urejevalnik maksimiran";
...
$AllowStudentsDownloadFoldersComment = "Dovoli uporabnikom pakiranje in prenos celotnih map iz orodja Dokumenti";
$AllowStudentsToCreateGroupsInSocialTitle = "Dovoli uporabnikom ustvarjenaje skupin v socialnem omrežju";
$AllowStudentsToCreateGroupsInSocialComment = "Dovoli tečajnikom ustvarjanje skupin v socialnem omrežju";
$AllowSendMessageToAllPlatformUsersTitle = "Dovoli pošiljanje sporočil vsem uporabnikom platforme";
$AllowSendMessageToAllPlatformUsersComment = "Dovoli pošiljanje sporočil vsem uporabnikom latforme";
$TabsSocial = "Zavihek socialnega omrežja";
$MessageMaxUploadFilesizeTitle = "Največja velikost datoteke v sporočilih";
$MessageMaxUploadFilesizeComment = "Največja velikost nalženih datotek v sporočilnem orodju (v zlogih)";
$AddAdditionalProfileField = "Dodaj polje uporabniškega profila";
$Username = "Uporabniško ime";
$ReadMoreLimitTitle = "Omejitev za (Preberi) Več ...";
$ReadMoreLimitComment = "Ta omejitev definira največje število prikazanih besed pred povezavo na preostanek besedila (Več ...)";
$AccessControlTitle = "V Internet Explorerju je aktivirana kontrola dostopa";
$AccessControlComment = "Kontrola dostopa lahko povzroči nepravilno izvajanje storitev v Dokeos. V primeru, da ga vaša organizacija uporablja, priporočamo, da možnost aktivirate.";
$CalendarTypesTitle = "Kateri dogodki naj bodo prikazani v koledarju?";
$CalendarTypesComment = "Koledar je poleg dogodkov zmožen prikazati tudi druge časovno določene informacije, kot so dogodki platforme, seje, testov, nalog/zadolžitev, datume potekov,...";
$AgendaDefaultViewTitle = "Privzeti pogled koledarja";
$AgendaDefaultViewComment = "Koledar ima tri osnovne poglede: mesečnega, tedenska in dnevnega. Kateri izmed naštetih naj bo uporabljen pri dostopu do koledarja?";
$MonthView = "Mesec";
$WeekView = "Teden";
$DayView = "Dan";
$AgendaActionIconsTitle = "Prikažem akcijske ikone v koledarju?";
$AgendaActionIconsComment = "Naj bo akcijske ikone (uredi, briši, vidnost, izvoz) prikazane v mesečnem, tedenskem in dnevnem pogledu na koledar?Te ikone se prikažejo, ko z miškinim kazalcem preletite dogodek.";
$ClickToEnableOrDisable = "Klikni za omogočanje ali onemogočanje";
$CourseSettingDelegationFalseClickToTrue = "Ta nastavitev je sedaj spremenljiva s strani upravitelja tečaja. Kliknite, če želite spremeniti";
$CourseSettingDelegationTrueClickToFalse = "Ta nastavitev je sedaj spremenljiva s strani upravitelja tečaja, Kliknite, če želite spremeniti";
$PlatformEvents = "Dogodki platforme";
$QuizEvents = "Dogodki vaj/testov";
$SessionEvents = "Dogodki seje";
$Trainings = "Tečaji";
