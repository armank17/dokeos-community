...
$NotMarkActivity = "Aktivnosti ni mogoče oceniti";
$YouHaveToCreateAtLeastOneAnswer = "Ustvariti morate vsaj en odgovor";
$ExerciseAttempted = "Tečajnikov poskus reševanja vaje/testa";
$MultipleSelectCombination = "Točna izbira";
$MultipleAnswerCombination = "Kombinacija odgovorov točne izbire";
$ExerciceExpiredTimeMessage = "Čas za test je potekel";
$ExercisesTracking = "Sledenje vaj/testov";
$TrackingByQuestions = "Sledenje po vprašanjih";
$TrackingByQuestionsDescription = "S sledenjem po vprašanjih vam je dana možnost ugotavljanja najpogostejšega odgovora na vprašanje, na katera vprašanja so slabo odgovarjali, ...";
$NumberOfAttempts = "Število poskusov";
$Scores = "Rezultat";
$AnsweredNothing = "Brez odgovora";
$GoodAnswer = "Dober odgovor";
$WrongAnswer = "Napačen odgovor";
$Percent = "Odstotek";
$Highest = "Najvišji";
$Average = "Povprečen";
$Lowest = "Najnižji";
$QuizQuestionsPool = "Zbirka vprašanj";
?>