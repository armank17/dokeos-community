...
<?php
$logo_sys_path = api_get_path(SYS_PATH).'home/default_platform_document/';
$logo_web_path = api_get_path(WEB_PATH).'home/default_platform_document/';
$logoimgpath="";
$logoimgext="";

	foreach (glob($logo_sys_path . 'temp_slide_*') as $path_file) {
...
*/
?>
<button style="float: right;" id="crop">CROP</button>
</div>
