...
$logo_web_path = api_get_path(WEB_PATH).'/home/logo/';
$logoimgpath="";
$logoimgext="";

	foreach (glob($logo_sys_path . 'temp_*') as $path_file) {
    ...
    $(document).ready(function() {
        ...
        $('#crop').click(function() {
			...
			$("#cropForm").ajaxForm({
                ...
                url: "<?php echo api_get_path(WEB_CODE_PATH) . 'index.php?module=courseInfo&cmd=InfoAjax&func=croplogohome'; ?>",
                success: function(data) {
