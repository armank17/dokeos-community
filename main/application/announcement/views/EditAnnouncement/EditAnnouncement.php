        ...
        if(!$("#id_description").val())
            {
                ...
                {
                    $.post('?module=announcement&cmd=EditAnnouncement&func=edit', $("#announcement_form").serialize(), function(data) {
...
<div id="announcement-content">
    ...
    <div id="announcement-content-right"><div id="divMessage"></div>
        <?php  
