...
class application_node_models_RegistrationPageModel 
{
    private $_ado;
    private $_sessionId;
    private $_nodeId;
    ...
    public function getPages() {
        $access_url_id=(api_get_current_access_url_id()==-1)?1:api_get_current_access_url_id();
               return $this->_ado->GetAll("SELECT
                                            ...
                                            node_type 
                                        FROM {$this->_tblNode}
                                        WHERE node_type =".NODE_TYPE_REGISTRATION_PAGE);
    }
    ...
    public function getPageInfo($nodeId) {
        ...
        return $this->_ado->GetRow("SELECT
                                            ...
                                            node_type 
                                        FROM {$this->_tblNode} 
                                        WHERE active =".NODE_ACTIVE." AND node_type =" .NODE_TYPE_REGISTRATION_PAGE. " 
