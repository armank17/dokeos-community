...
require_once dirname(__FILE__).'/../inc/lib/templatemanager.lib.php';
...
mysql_query("CREATE DATABASE IF NOT EXISTS `$mysqlMainDb` DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci") or die(mysql_error());
...
if($mysqlStatsDb != $mysqlMainDb)
{
	if(!$singleDbForm)
	{
		...
		mysql_query("CREATE DATABASE `$mysqlStatsDb` DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci") or die(mysql_error());
	}
	else
	{
...
if($mysqlUserDb != $mysqlMainDb)
{
	if(!$singleDbForm)
	{
		...
		mysql_query("CREATE DATABASE `$mysqlUserDb` DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci") or die(mysql_error());
	}
	else
	{
...
// Add Templates
$_configuration['main_database'] = $mysqlMainDb;
TemplateManager::addTemplatesToAccessUrlId(1);
?>
