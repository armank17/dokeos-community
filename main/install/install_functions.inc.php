...
function display_requirements($installType, $badUpdatePath, $updatePath='', $update_from_version_8=array(), $update_from_version_6=array(), $update_from_version_20=array())
{
	...
	echo '<table class="requirements">
			...
			<tr>
				<td class="requirements-item">dokeos/home/default_platform_document/</td>
				<td class="requirements-value">'.check_writable('../home/default_platform_document/').'</td>
			</tr>
			<tr>
				<td class="requirements-item">dokeos/home/default_platform_document/template_thumb/</td>
				<td class="requirements-value">'.check_writable('../home/default_platform_document/template_thumb/').'</td>
			</tr>
			<tr>
				<td class="requirements-item">dokeos/home/logo/</td>
				<td class="requirements-value">'.check_writable('../home/logo/').'</td>
			</tr>
			<tr>
	...
	if($installType == 'update' && (empty($updatePath) || $badUpdatePath))
	{
		...
		?>
			...
			<td colspan="2" align="left">
				<button type="submit" class="new-previous-link" name="step1" value="&lt; <?php echo get_lang('Back');?>" >&nbsp;&nbsp;<?php echo get_lang('Back');?></button>
				<input type="hidden" name="is_executable" id="is_executable" value="-" />
	...
	else
	{
		...
		if(!is_writable('../../home/default_platform_document')) {
			$notwritable[] = realpath($curdir.'/../../home/default_platform_document');
			@chmod('../../home/default_platform_document',$perm);
		}
		if(!is_writable('../../home/default_platform_document/template_thumb')) {
			$notwritable[] = realpath($curdir.'/../../home/default_platform_document/template_thumb');
			@chmod('../../home/default_platform_document/template_thumb',$perm);
		}
		if(!is_writable('../../home/logo')) {
			$notwritable[] = realpath($curdir.'/../../home/logo');
			@chmod('../../home/logo',$perm);
		}
		...
		?>
		<!--<p align="left" style="margin-top:15px; border:1px solid blue"></p>-->
		<div style="  float: left;    height: 100px;    margin-right: 10px;    margin-top: 20px;    padding-top: 55px;    width: 100px;">
                    <button type="submit" name="step1" class="new-previous-link" onclick="window.location='index.php';return false;" value="&lt; <?php echo get_lang('Previous'); ?>" >&nbsp;&nbsp;<?php echo get_lang('Previous'); ?>
                    </button>
                </div>
		
                <div style=" float: right;     margin-top: 20px;     width: 170px;">
                    <button style="border-radius: 130px;  -moz-border-radius: 130px;    -webkit-border-radius: 130px;  float: right;    height: 150px;    margin-bottom: 10px;    margin-left: 0;    width: 150px;" type="submit" name="step2_install" class="add" value="<?php echo get_lang("NewInstallation"); ?>" <?php if($error) if($error)echo 'disabled="disabled"'; ?> ><?php echo get_lang('NewInstallation'); ?></button>
                </div>
        
                <div style=" text-align:center;     float: right;    margin-right: 20px;    margin-top: 42px;    width: 320px;">
                
		<input type="hidden" name="is_executable" id="is_executable" value="-" />
		<?php
		//real code
		echo '<button style="margin-bottom:10px; text-transform: capitalize;" type="submit" style="margin-bottom:10px;" class="upgrade_link" name="step2_update_8" value="Upgrade from Dokeos 1.8.x"';
		...
		echo '<button style="text-transform: capitalize;" type="submit" class="upgrade_link" name="step2_update_20" value="Upgrade from Dokeos 2.0.x"';
                if($error) echo ' disabled="disabled"';
	...
	<table><tr><td>
		...
		<table width="100%">
			<tr>
				<td></td>
				<td align="left">
					<button type="submit" class="new-previous-link" name="step1" value="&lt; <?php echo get_lang('Previous'); ?>" >&nbsp;&nbsp;<?php echo get_lang('Previous'); ?></button>
					<input type="hidden" name="is_executable" id="is_executable" value="-" />
...
function display_database_settings_form($installType, $dbHostForm, $dbUsernameForm, $dbPassForm, $dbPrefixForm, $enableTrackingForm, $singleDbForm, $dbNameForm, $dbStatsForm, $dbScormForm, $dbUserForm)
{
	...
	<tr>
		<td valign="top" colspan="3"><button type="submit" class="login_link checkbutton"  name="step3" value="<?php echo get_lang('CheckDatabaseConnection'); ?>" id="checkdatabaseconnection" onclick="javascript:check_mysql_connection();return false;">&nbsp;&nbsp;<?php echo get_lang('CheckDatabaseConnection'); ?></button></td>
	...
	<tr>
	  <td><br/><br/><br/><br/>
	  <button type="submit" name="step2" class="new-previous-link" value="&lt; <?php echo get_lang('Previous'); ?>" >&nbsp;&nbsp;<?php echo get_lang('Previous'); ?></button></td>
	  <td><br/><br/><br/><br/>&nbsp;</td>
...
function display_configuration_settings_form($installType, $urlForm, $languageForm, $emailForm, $adminFirstName, $adminLastName, $adminPhoneForm, $campusForm, $institutionForm, $institutionUrlForm, $encryptPassForm, $allowSelfReg, $allowSelfRegProf, $loginForm, $passForm)
{
	...
	<tr>
	  <td><button type="submit" class="new-previous-link" name="step3" value="&lt; <?php echo get_lang('Previous'); ?>" />&nbsp;&nbsp;<?php echo get_lang('Previous'); ?></button></td>
...
function display_after_install_message($installType, $nbr_courses)
{
	...
	printf(get_lang('ToProtectYourSiteMakeXAndYReadOnly'),'main/inc/conf/configuration.php','main/install/index.php');
        ...
        if (is_dir(api_get_path(SYS_PATH).'PRO')) {
            $url_query = '?action=makeitpro';
        }        
        $message .= ' <a href="../../index.php'.$url_query.'"><b style="text-transform:uppercase;">'.get_lang('GoToYourNewlyCreatedPortal')."</b></a>";
