...
/**
==============================================================================
* Updates the Dokeos files from version 2.0 to version 2.1
...
if (defined('DOKEOS_INSTALL') || defined('DOKEOS_COURSE_UPDATE'))
{
	...
	//document/mindmaps
	//require 0777 because used by java socket
	if(!is_dir($currentCourseRepositorySys."document/mindmaps")){
		mkdir($currentCourseRepositorySys."document/mindmaps",0777);
		}
