	...
	if ($fp = @fopen($filepath.$filename.'.'.$extension, 'w')) {
		...
		if ($document_id) {
            ...
            if (in_array($ext, $allowed_file_types)) {
			   echo '<script type="text/javascript">window.location.href="showinframes.php?'.api_get_cidReq().'&file='.$save_file_path.'&curdirpath='.$dir.$param_group.'";</script>';
			} else {
                           echo '<script type="text/javascript">window.location.href="document.php?'.api_get_cidReq().'&curdirpath='.$dir.$param_group.'";</script>';
			}
			exit ();
		} else {
