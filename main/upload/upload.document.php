...
if(isset($_GET['createdir']))
{
	...
	?>
	<p><a href="<?php echo api_get_self(); ?>?path=<?php echo $path; ?>&amp;createdir=1"><img src="../img/new_folder.gif" border="0" align="middle" alt ="" /> <?php echo(get_lang('CreateDir'));?></a></p>
	<?php
}
?>
...
<td>
    <input type="file" name="user_upload" title="<?php echo get_lang('Upload'); ?>">
</td>
</tr>
<?php
