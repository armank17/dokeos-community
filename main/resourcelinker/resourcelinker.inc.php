...
function display_addedresource_link_in_learnpath($type, $id, $completed, $id_in_path, $builder, $icon, $level = 0)
{
	...
	switch ($type)
	{
		case "Agenda":
			...
			if ($icon == 'icon') { echo "<img src='../img/agenda.png' align=\"middle\" alt='agenda'>"; }
			if ($builder != 'builder')
			{
		...
		case "Ad_Valvas":
			...
			if ($icon == 'icon') { echo "<img src='../img/valves.png' align=\"middle\" alt='ad valvas'>"; }
			if ($builder != 'builder')
			{
		...
		case "Link" :
			...
			if ($icon == 'icon')
			{
				if ($linktype=='Link _self') { echo "<img src='../img/links.gif' align=\"middle\" alt='links'>"; }
				   else { echo "<img src='../img/link_blank.gif' align=\"middle\" alt='blank links'>"; }
			}
			$thelink=$myrow["url"];
			if ($builder != 'builder')
			{
		...
		case "Exercise":
			...
			if ($icon == 'nolink') { return(shorten($myrow["title"],$length)); }
			if ($icon == 'icon') { echo "<img src='../img/quiz.gif' align=\"middle\" alt='quizz'>"; }
			if ($builder != 'builder')
			{
		...
		case "HotPotatoes":
			...
			if ($icon == 'icon') { echo "<img src='../img/jqz.gif' align=\"middle\" alt='hot potatoes'>"; }
		...
		case "Forum":
			...
			if ($icon == 'icon') { echo "<img src='../img/forum.gif' align=\"middle\" alt='forum'>"; }
		...
		case "Document":
			...
			if ($icon == 'icon') { echo "<img src='../img/$image' align=\"middle\" alt='$image'>"; }
			if ($builder != 'builder')
			{
		...
		case "Assignments":
			...
			if ($icon == 'nolink') { return(shorten($name,$length)); }
			if ($icon == 'icon') { echo "<img src='../img/works.gif' align=\"middle\">"; }
			if ($builder != 'builder')
			{
		...
		case "Dropbox":
			...
			if ($icon == 'nolink') { return(shorten($name,$length)); }
			if ($icon == 'icon') { echo "<img src='../img/dropbox.gif' align=\"middle\">"; }
		...
		case "Introduction_text":
			...
			if ($icon == 'nolink') { return(shorten($name,$length)); }
			if ($icon == 'icon') { echo "<img src='../img/introduction.gif' align=\"middle\" alt='introduction'>"; }
		...
		case "Course_description":
			...
			if ($icon == 'nolink') { return(shorten($name,$length)); }
			if ($icon == 'icon') { echo "<img src='../img/info.gif' align=\"middle\" alt='info'>"; }
		...
		case "Groups":
			...
			if ($icon == 'nolink') { return(shorten($name,$length)); }
			if ($icon == 'icon') { echo "<img src='../img/group.gif' align=\"middle\" alt='group'>"; }
		...
		case "Users":
			...
			if ($icon == 'nolink') { return(shorten($name,$length)); }
			if ($icon == 'icon') { echo "<img src='../img/members.gif' align=\"middle\" alt='members'>"; }
