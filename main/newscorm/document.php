...
if (is_array($fileList) && count($fileList) > 0) {
    array_multisort($fileList['type'], $fileList['name'], $fileList['size'], $fileList['date'], $fileList['comment'], $fileList['visibility']);
}
/* ----------------------------------------
...
if (api_is_allowed_to_edit()) {
    ...
    "<img src='../img/scormbuilder.gif' border=\"0\" align=\"middle\" alt='scormbuilder' />" . get_lang('_add_learnpath') . "</a>
      </td>",
    "<td valign='bottom'>&nbsp;&nbsp;&nbsp;<a href='" . api_get_self() . "?createDir=$cmdCurDirPath'>",
    "<img src=\"../img/dossier.gif\" border=\"0\" align=\"middle\" />",
...
if ($fileList) {
    ...
    while (list($fileKey, $fileName) = each($fileList['name'])) {
        ...
        if (file_exists($indexRoute1)) {
            ...
            $image = "<img src=\"./../img/scorm_logo.gif\" border=\"0\" align=\"middle\" alt='scorm' />";
            ...
            $image = "<img src=\"../img/dossier.gif\" border=\"0\"  hspace=\"3\" align=\"middle\" alt='scorm'>";
        }
