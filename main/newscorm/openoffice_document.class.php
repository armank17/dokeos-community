...
abstract class OpenofficeDocument extends learnpath {
    ...
    function convert_document($file, $action_after_conversion='make_lp'){
		...
		$this->created_dir = create_unexisting_directory($_course,$_user['user_id'],0,0,$this->base_work_dir,$dir_name,'','ppt');
		...
		$this->lp_id = learnpath::add_lp($_course['id'], $file['name'],'','guess','manual');
