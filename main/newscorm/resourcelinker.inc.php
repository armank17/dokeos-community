...
function display_addedresource_link_in_learnpath($type, $id, $completed, $id_in_path, $builder, $icon, $level = 0) {
    ...
    if ($builder != 'builder')
        $origin = 'learnpath'; //origin = learnpath in student view
    $linktype = $type;
    ...
    switch ($type) {
        ...
        case "Agenda":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/agenda.png' align=\"middle\" alt='agenda'>";
            }
            if ($builder != 'builder') {
        ...
        case "Ad_Valvas":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/valves.png' align=\"middle\" alt='ad valvas'>";
            }
            if ($builder != 'builder') {
        ...
        case "Link" :
            ...
            if ($icon == 'icon') {
                if ($linktype == 'Link _self') {
                    echo "<img src='../img/links.gif' align=\"middle\" alt='links'>";
                } else {
                    echo "<img src='../img/link_blank.gif' align=\"middle\" alt='blank links'>";
                }
            }
            $thelink = $myrow["url"];
            if ($builder != 'builder') {
        ...
        case "Exercise":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/quiz.gif' align=\"middle\" alt='quizz'>";
            }
            if ($builder != 'builder') {
        ...
        case "HotPotatoes":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/jqz.jpg' align=\"middle\" alt='hot potatoes'>";
            }
        ...
        case "Forum":
            ...
            if ($myrow["forum_name"] == '') {
                $type = "Forum";
                echo "<span class='messagesmall'>" . get_lang('StepDeleted1') . " $type " . get_lang('step_deleted2') . "</span>";
                return(true);
            }
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/forum.gif' align=\"middle\" alt='forum'>";
            }
        ...
        case "Document":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/$image' align=\"middle\" alt='$image'>";
            }
            if ($builder != 'builder') {
        ...
        case "Assignments":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/works.gif' align=\"middle\">";
            }
            if ($builder != 'builder') {
        ...
        case "Dropbox":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/dropbox.gif' align=\"middle\">";
            }
        ...
        case "Introduction_text":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/introduction.gif' align=\"middle\" alt='introduction'>";
            }
        ...
        case "Course_description":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/info.gif' align=\"middle\" alt='info'>";
            }
        ...
        case "Groups":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/group.gif' align=\"middle\" alt='group'>";
            }
        ...
        case "Users":
            ...
            if ($icon == 'icon') {
                echo "<img src='../img/members.gif' align=\"middle\" alt='members'>";
            }
...
function display_added_resources($type, $id, $style = '') {
    ...
    while ($row = Database::fetch_array($result)) {
        if ($origin != 'learnpath') {
            ...
            display_addedresource_link_in_learnpath($row['resource_type'], $row['resource_id'], 'agendaitems', '', 'builder', 'icon');
            echo "<br>";
        }
    }
}
    ...
    switch ($type) {
        ...
        case TOOL_THREAD:  //forum post
            ...
            if (!empty($id)) {
                ...
                $result = Database::query($sql, __FILE__, __LINE__);
                $myrow = Database::fetch_array($result);
                $link .= $main_dir_path . 'forum/viewthread.php?origin=learnpath&thread=' . $id . '&forum=' . $myrow['forum_id'] . '&lp=true&' . api_get_cidreq();
            }
            break;
...
//            $link .= $main_dir_path . 'work/work.php?' . api_get_cidreq() . '&origin=learnpath&gradebook=&curdirpath=' . $curdirpath . '&assignment_id=' . $id;
            $link .= $main_dir_path . 'core/views/work/index.php?' . api_get_cidreq() . '&origin=learnpath&action=view_papers&curdirpath=' . $curdirpath . '&assignment_id=' . $id;
            break;
        case TOOL_SURVEY :
            $sql_survey = "SELECT question_per_page FROM " . Database::get_course_table(TABLE_SURVEY) . " WHERE survey_id = '".Database::escape_string($id)."'";
            $result_survey = Database::query($sql_survey, __FILE__, __LINE__);
            $row = Database::fetch_array($result_survey);
            $allinone = ($row['question_per_page'] != 0) ? 'all' : '';
            if (api_is_allowed_to_edit()) {
                $link .= $main_dir_path . 'survey/preview' . $allinone . '.php?survey_id=' . $id . '&origin=learnpath&' . api_get_cidreq();
            } else {
                $uid = api_get_user_id();
                ...
                // Survey link
                $link .= $main_dir_path . 'survey/fillsurvey' . $allinone .'.php?course=' . api_get_course_id() . '&origin=learnpath&invitationcode=' . $invitation_code. '&' . api_get_cidreq();
            }
