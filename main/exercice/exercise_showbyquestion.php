...
// destruction of the Question object
	...
	$colspan=2;
	?>
	<div style="padding:0px 0px 20px 0px;"><div class="rounded" style="width: 100%; padding: 1px; background-color:#fff;"><table class="rounder_inner" style="width: 100%; background-color:#fff;"><tr><td valign="top">
	...
	if ($show_results) {
		...
		if($dsp_percent == true) {
			...
			$my_total_score  = round(float_format($total_score,1));
			$my_total_weight = round(float_format($total_weighting,1));
