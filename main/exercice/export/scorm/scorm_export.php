...
class ScormAssessmentItem
{
	...
	function css()
	{
		if($this->standalone)
		{
			...
			$css .= '/*<![CDATA[*/'."\n";
			$css .= '@import "'.api_get_path(WEB_PATH).'main/css/'.$platform_theme.'/default.css";'."\n";
			$css .= '@import "'.api_get_path(WEB_PATH).'main/css/'.$platform_theme.'/templates.css";'."\n";
			$css .= '/*]]>*/'."\n";
			$css .= '</style>'."\n";
			$css .= '<style type="text/css" media="print">'."\n";
			$css .= '/*<![CDATA[*/'."\n";
			$css .= '@import "'.api_get_path(WEB_PATH).'main/css/'.$platform_theme.'/print.css";'."\n";
			$css .= '/*]]>*/'."\n";
			$css .= '</style>'."\n";
			return $css;
		}
		...
		$js .= "\n" . 
            ...
            function addListeners(e) {
            	...
            	*/
                ...
                addEvent(my_button,\'click\',messageButton,false);
    ...
    function end_body()
    {
    	if($this->standalone){return '<br /><input  style="background-color: #000000;border:1px solid #7f7f7f;border-radius: 8px; -moz-border-radius: 8px; -webkit-border-radius: 8px; cursor: pointer; min-height: 28px; padding:5px;color:#ffffff;vertical-align:middle; text-transform:uppercase; font-weight:bold;float:right;margin-right:20px;margin-bottom:20px;width:100px;" type="button" id="dokeos_scorm_submit" name="dokeos_scorm_submit" value="OK" /></form>'."\n".'</body>'. "\n";}
    	return '';
    }
...
class ScormSection
{
    ...
    function start_body()
    {
       return '<body>'. "\n".
			...
			'<form  id="dokeos_scorm_form" method="post" action="">'."\n".
			'<table width="95%" align="center" style="border-collapse:separate;border-spacing:10px;">'."\n";
    }
    ...
    function end_body()
    {
       return '</table><br /><input style="background-color: #000000;border:1px solid #7f7f7f;border-radius: 8px; -moz-border-radius: 8px; -webkit-border-radius: 8px; cursor: pointer; min-height: 28px; padding:5px;color:#ffffff;vertical-align:middle; text-transform:uppercase; font-weight:bold;float:right;margin-right:20px;margin-bottom:20px;width:100px;" type="button" id="dokeos_scorm_submit" name="dokeos_scorm_submit" value="OK" /></form>'."\n".'</body>'. "\n";
    }
