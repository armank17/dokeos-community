...
if (!empty($lp))
{
	$lp_url= api_get_path(WEB_CODE_PATH).'newscorm/lp_controller.php?'.api_get_cidreq().'&action=view&lp_id='.$lp.'&switch=item';
...
echo '<script type="text/javascript"> function SendEx(num)
	  {
	  	if (num==-1)
	  	{
