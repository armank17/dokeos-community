		...
		while ($myrow = Database::fetch_array($result)) {
			...
			if ($myrow['visibility'] == '1')
			{
                ...
                if (api_is_allowed_to_edit ()) {
                  echo "<td align=\"left\" valign=\"middle\" width=\"6%\" class='$draggable_class'>".Display::return_icon('pixel.gif', null, array('class' => 'actionplaceholdericon actionsdraganddrop'))."</td>";                
                }else{
                  echo "<td align=\"left\" valign=\"middle\" width=\"6%\" class='$draggable_class'>".Display::return_icon('pixel.gif', null, array('class' => 'placeholdericon toolshortcut_links'))."</td>";                      
                }
