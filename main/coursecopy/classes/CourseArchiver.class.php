...
class CourseArchiver {
     ...
     */
    public function clean_backup_dir() {
     ...
     */
    public function write_course($course) {
     ...
     *
     */
    public function get_available_backups($user_id = null) {
     ...
     */
    public function read_course($filename, $delete = false) {
        CourseArchiver::clean_backup_dir();
        // Create a temp directory
        $tmp_dir_name = 'CourseArchiver_' . uniqid('');
