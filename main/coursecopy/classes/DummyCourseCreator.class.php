...
class DummyCourseCreator {
     ...
     */
    public function create_dummy_announcements() {
        $property = $this->default_property;
     ...
     * Create dummy links
     */
    public function create_dummy_links() {
        // create categorys
     ...
     * Create dummy forums
     */
    public function create_dummy_forums() {
     ...
     */
    public function create_dummy_learnpaths() {
     ...
     */
    public function get_dummy_content($type) {
