...
<?php
                ...
                <div id="display_response_id" style="height:200px;">
					...
					<textarea id="txt_area_invite" rows="5" cols="40"><?php echo api_convert_encoding(get_lang('DefaultInvitationContent').api_get_setting('siteName'), $charset, mb_detect_encoding(get_lang('DefaultInvitationContent').api_get_setting('siteName'))); ?></textarea><br /><br />
