...
class WS {
	...
	/**
	 * Gets the real user id based on the user id field name and value. Note that if the user id field name is "dokeos_user_id", it will use the user id
	...
	/**
	 * Gets the real course id based on the course id field name and value. Note that if the course id field name is "dokeos_course_id", it will use the course id
	 * in the system database
	 * 
	...
	protected function getCourseId($course_id_field_name, $course_id_value) {
            if($course_id_field_name == "dokeos_course_id") {
	...
	/**
	 * Gets the real session id based on the session id field name and value. Note that if the session id field name is "dokeos_session_id", it will use the session id
	 * in the system database
	 * 
	...
	protected function getSessionId($session_id_field_name, $session_id_value) {
		if($session_id_field_name == "dokeos_session_id") {
