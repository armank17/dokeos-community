...
$s->register(
	'WSCourse.CourseModules',
	array(
		'secret_key' => 'xsd:string',
		'course_id_field_name' => 'xsd:string',
		'course_id_value' => 'xsd:string'
	),
	array('return' => 'tns:courseMod_array')
);
...
$s->wsdl->addComplexType(
	...
	'',
	array(
                'lp_id' => array('name' => 'lp_id', 'type' => 'xsd:string'),
		'lp_name' => array('name' => 'lp_name', 'type' => 'xsd:string'),
		'lp_type' => array('name' => 'lp_type', 'type' => 'xsd:string')
	)
);
...
$s->wsdl->addComplexType(
	...
	'SOAP-ENC:Array',
	array(),
	array(array('ref'=>'SOAP-ENC:arrayType', 'wsdl:arrayType' => 'tns:courseMod[]')),
	'tns:courseMod'
);
