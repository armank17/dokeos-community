...
#location2{
	margin: 0 200px 0 250px; /*Margins for content column. Should be "0 location4Width 0 location3Width*/
...
#location4{
	...
	margin-left: -200px; /*Set left marginto -(location4Width)*/
}
...
<div id="location5" class="location widget" title="<?php echo get_lang('Locationlocation5');?>"> &nbsp;
