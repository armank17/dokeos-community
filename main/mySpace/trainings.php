    ...
    if ($export_csv) {
        ...
        echo '
		 <div class="report_section">
			...
			<table class="data_table_trainings">
				<tr>
					<td>
...
if (api_is_allowed_to_create_course() && $view == 'teacher') {
    ...
    if ($nb_teacher_courses) {
        ...
        $table->set_header(2, get_lang('AvgTimeSpentInTheCourse') . Display :: return_icon('info3.png', get_lang('TimeOfActiveByTraining'), array('align' => 'middle', 'hspace' => '3', 'class' => "print_invisible")), false);
        $table->set_header(3, get_lang('AvgStudentsProgress') . Display :: return_icon('info3.png', get_lang('AvgAllUsersInAllCourses'), array('align' => 'middle', 'hspace' => '3', 'class' => "print_invisible")), false);
        $table->set_header(4, get_lang('AvgCourseScore') . Display :: return_icon('info3.png', get_lang('AvgAllUsersInAllCourses'), array('align' => 'middle', 'hspace' => '3', 'class' => "print_invisible")), false);
        $table->set_header(5, get_lang('AvgExercisesScore') . Display :: return_icon('info3.png', get_lang('AvgAllUsersInAllCourses'), array('align' => 'middle', 'hspace' => '3', 'class' => "print_invisible")), false);
