...
foreach ($connections as $key => $data) {
	$result_to_print .= '<li style="margin: 10px;">' . date('d-m-Y (H:i:s)', $data['login']).' - '.api_time_to_hms($data['logout'] - $data['login']) . '</li>';
}
...
echo '<div class="scroll-pane" style="max-height:400px;overflow-y:scroll;margin:20px 40px 20px 0">';
...
echo '<script type="text/javascript">
          $(function()
          {
              $("div.scroll-pane").jScrollPane({verticalDragMinHeight: 12});
          });
      </script>';
