...
if (isset ($_GET['selectcat'])) {
	...
	$actions.= '<a href=gradebook_flatview.php?selectcat=' .Security::remove_XSS($_GET['selectcat']) . '>' . Display::return_icon('pixel.gif', get_lang('BackTo').' '.get_lang('FlatView'),array('class'=>'toolactionplaceholdericon toolactionback')).get_lang('BackTo').' '.get_lang('FlatView').'</a>&nbsp&nbsp';
...
if (isset ($_GET['selecteval'])) {
	...
	$actions.= '<a href=gradebook_view_result.php?selecteval=' . Security::remove_XSS($_GET['selecteval']) . '><img src=../img/lp_leftarrow.gif alt=' . get_lang('BackToEvaluation') . ' align=middle/> ' . get_lang('BackToEvaluation') . '</a>&nbsp&nbsp';
}
...
Display::display_tool_header(get_lang('ResultsPerUser'));
