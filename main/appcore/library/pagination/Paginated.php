...
class appcore_pagination_Paginated {
	 ...
	 */
	public function setLayout(appcore_pagination_PageLayout $layout) {
		$this->layout = $layout;
	}
	...
	public function fetchPagedNavigation($queryVars = "",$functionSt='',$params=array()) {
		return $this->getLayout()->fetchPagedLinks($this, $queryVars,$functionSt,$params);
	}//end writeNavigation
}//end Paginated
?>
