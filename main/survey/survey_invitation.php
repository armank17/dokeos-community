...
{
	Display::display_error_message(get_lang('Error'), false, true);
	Display::display_footer();
	exit;
}
...
{
	Display::display_normal_message(get_lang('AnonymousSurveyCannotKnowWhoAnswered').' '.count($answered_data).' '.get_lang('PeopleAnswered'), false, true);
	$answered_data = array();
}
